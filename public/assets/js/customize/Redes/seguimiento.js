$(function () {
    ...
    tabla.generaTablaPersonal('#data-table-redes', null, null, true, true, [[0, 'desc']]);
    ...
    $('#data-table-redes tbody').on('click', 'tr', function () {
        var datos = $('#data-table-redes').DataTable().row(this).data();
        if (datos !== undefined) {
            ...
            if (operacion === '1') {
                ...
                $('#btnIniciarServicio').on('click', function () {
                    ...
                    evento.enviarEvento('Seguimiento/Servicio_Datos', data, '#modal-dialogo', function (respuesta) {
                        ...
                        recargandoTablaRedes(respuesta.informacion);
                    });
                });
