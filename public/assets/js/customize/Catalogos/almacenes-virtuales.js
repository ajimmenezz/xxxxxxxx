$(function () {
    ...
    $("#btnAgregarAlmacen").on("click", function () {
        evento.enviarEvento(
                "Catalogo/MostrarFormularioAlmacen",
                "",
                "#seccionAlmacenes",
                function (respuesta) {
                                    ...
                                    function (respuesta) {
                                        if (respuesta instanceof Array || respuesta instanceof Object) {
                                            ...
                                            $.each(respuesta, function (key, valor) {
                                                ...
                                                tabla.agregarFila("#data-table-almacenes", [
                                                    valor.Id,
                                                    valor.Nombre,
                                                    valor.Tipo,
                                                    activacion
                                            ...
                                            evento.mostrarMensaje(
                                                    ".errorAlmacen",
                                                    false,
                                                    "Ya existe un almacén con el mismo nombre y responsable.",
                                                    3000
                                                    );
                                        }
                                    }
    ...
    $("#btnTraspasarAlmacenes").on("click", function () {
        evento.enviarEvento(
                "Catalogo/MostrarFormularioTraspaso",
                {},
                "#seccionAlmacenes",
                function (respuesta) {
                    $("#divTraspasarProducto")
                            .empty()
    ...
    $("#btnVerAltasIniciales").on("click", function () {
        evento.enviarEvento(
                "Catalogo/MostrarAltasIniciales",
                {},
                "#seccionAlmacenes",
                function (respuesta) {
                    $("#divVerAltasIniciales")
                            .empty()
                            .append(respuesta.html);
    ...
    $("#btnHistorialEquipo").on("click", function () {
        evento.enviarEvento(
                "Catalogo/MostrarFormularioHistorialEquipo",
                {},
                "#seccionAlmacenes",
                function (respuesta) {
                    $("#divHistorialEquipo")
    ...
    function verHistorialEquipo() {
        ...
        $("#btnBuscarHistorialEquipo").on("click", function () {
            ...
            if (id !== "") {
                evento.enviarEvento(
                        "Catalogo/MostrarHistorialEquipo",
                        {id: id},
                        "#panelHistorialEquipo",
                        function (respuesta) {
                            tabla.limpiarTabla("#data-table-movimientos");
                            $.each(respuesta, function (k, v) {
                                tabla.agregarFila("#data-table-movimientos", [
                                    v.Movimiento,
                                    v.Almacen,
                                    v.TipoProducto,
                                    v.Producto,
                ...
                evento.mostrarMensaje(
                        ".divError",
                        false,
                        "La serie de equipo es necesaria para la generación del historial",
                        4000
                        );
                tabla.limpiarTabla("#data-table-movimientos");
                $("#divResult").hide();
    ...
    function verDeshuesarEquipo() {
        ...
        evento.enviarEvento(
                "Catalogo/MostrarDeshuesarEquipo",
                {},
                "#seccionAlmacenes",
                function (respuesta) {
                    $("#divDeshuesarEquipo")
                            ...
                            if (typeof notificacion !== "undefined") {
                                if (notificacion == 1) {
                                    evento.mostrarMensaje(
                                            "#errorDeshuesar",
                                            true,
                                            "Los componentes y sus estatus han sido agregados a su inventario.",
                                            4000
                                            );
                                } else {
                                    evento.mostrarMensaje(
                                            "#errorDeshuesar",
                                            false,
                                            "Ocurrió un error al intentar convertir el equipo a componentes. Intente de nuevo o contacte al administrador del sistema.",
                                            4000
                                            );
                                }
                            }
                    ...
                    $("#divDeshuesarEquipo #divListaEquiposDeshuesar #btnRegresar").off(
                            "click"
                            );
                    $("#divDeshuesarEquipo #divListaEquiposDeshuesar #btnRegresar").on(
                            "click",
                            function () {
    ...
    function initDeshuesarEquipos() {
        $("#data-table-equipos-deshueso tbody").on("click", "tr", function () {
            var _datos = {
                datos: $("#data-table-equipos-deshueso")
                        .DataTable()
                        .row(this)
                        .data()
            };
            evento.enviarEvento(
                    "Catalogo/MostrarComponentesDeshueso",
                    _datos,
                    "#panelDeshuesarEquipo",
                    function (respuesta) {
                        $("#divListaComponentesDeshuesar")
                                .empty()
                                .append(respuesta.html);
                        tabla.generaTablaPersonal(
                                "#data-table-componentes-deshueso",
                                null,
                                null,
                                true,
                                false,
                        ...
                        $("#divListaComponentesDeshuesar #btnRegresar").on(
                                "click",
                                function () {
                        ...
                        $("#btnGuargarDeshuesoEquipo").on("click", function () {
                            if (
                                    evento.validarFormulario("#formularioSeriesCaptureComponentes")
                                    ) {
                                ...
                                $(".list-estus-componentes-deshueso").each(function () {
                                    data.componentes.push({
                                        ...
                                        Cantidad: 1,
                                        Serie: $(
                                                "#serie-componente-deshueso-" + $(this).attr("data-id")
                                                ).val()
                                    });
                                });
                                ...
                                if (sinSerie > 0) {
                                    listaErrores.push(
                                            sinSerie + " producto(s) no cuentan con Serie registrada."
                                            );
                                }

                                var html =
                                        '<h4 class="text-center">Se han encontrado las siguientes advertencias:</h4><h5 class="bg-warning"><ul>';
                                ...
                                html +=
                                        '</ul></h5><br /><h4 class="text-center">¿Desea proceder con el guardado de información?</h4>';
    ...
    function saveComponentesDeshueso() {
        ...
        evento.enviarEvento(
                "Catalogo/GuardarComponentesDeshueso",
                datos,
                "#panelDeshuesarEquipo",
                function (respuesta) {
    ...
    $("#data-table-almacenes tbody").on("click", "tr", function () {
        ...
        evento.enviarEvento(
                "Catalogo/MostrarAlamacenVirtual",
                _datos,
                "#seccionAlmacenes",
                function (respuesta) {
                    ...
                    if (respuesta.tipoAlmacen == 1 || respuesta.tipoAlmacen == 4) {
                        ...
                        $("#btnFiltrarMovimientos").on("click", function () {
                            ...
                            evento.enviarEvento(
                                    "Catalogo/FiltrarMovimientosInventario",
                                    datos,
                                    "#panelInventarioAlmacen",
                                    function (respuesta) {
                                        tabla.limpiarTabla("#data-table-movimientos");
                            ...
                            evento.enviarEvento(
                                    ...
                                    function (respuesta) {
                                        if (respuesta.estatus) {
                                            ...
                                            evento.mostrarMensaje(
                                                    "#errorInventarioAlmacen",
                                                    false,
                                                    "No se pudo cerrar el Alta. Intente de nuevo o recargue su página. Si el problema persiste, contácte al Administrador",
                                                    4000
                                                    );
                                        }
                                    }
                        ...
                        $("#btnAddInicialPoliza").on("click", function () {
                            evento.enviarEvento(
                                    "Catalogo/AgregarProductoPoliza",
                                    {},
                                    "#panelInventarioAlmacen",
                                    function (respuesta) {
                                        ...
                                        $("#txtCantidad").bind("keyup mouseup", function () {
                                            ...
                                            var campos = $("#formularioSeriesCapture").children("div.row")
                                                    .length;
                                            var contador = 0;
                                                    ...
                                                    for (var i = 0; i < cantidad; i++) {
                                                        ...
                                                        <div class="col-md-5 col-sm-5 col-xs-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="info-serie-` +
                                                                    (i + 1) +
                                                                    ` form-control" placeholder="Introduce Serie" />
                                                            </div>
                                                        </div>
                                                        <div class="col-md-5 col-sm-5 col-xs-12">
                                                            <div class="form-group">
                                                                <label class="f-w-600">Estatus *</label>
                                                                <select id="list-info-estatus-` +
                                                                    (i + 1) +
                                                                    `" class="listEstatusProductos form-control" data-parsley-required="true">
                                        ...
                                        $("#btnGuardarProductoPoliza").on("click", function () {
                                            if (evento.validarFormulario("#formAddProducto")) {
                                                if (evento.validarFormulario("#formularioSeriesCapture")) {
                                                    ...
                                                    var componente = $(
                                                            "#listRefacciones option:selected"
                                                            ).val();
                                                    if (componente != "") {
                                                        tipoProducto = 2;
                                                        producto = componente;
                            ...
                            evento.enviarEvento(
                                    ...
                                    function (respuesta) {
                                        ...
                                        $("#listModelos").on("change", function () {
                                            ...
                                            evento.enviarEvento(
                                                    "Catalogo/CargaSubelementosSalas4D",
                                                    datos,
                                                    "#panelAgregarProducto",
                                                    function (respuesta) {
                                                        $.each(respuesta.componentes, function (k, v) {
                                                    ...
                                                    for (var i = 0; i < cantidad; i++) {
                                                        ...
                                                        <div class="col-md-5 col-sm-5 col-xs-12">
                                                            <div class="form-group">
                                                                ...
                                                                <select id="list-info-estatus-` +
                                                                    (i + 1) +
                                                                    `" class="form-control listEstatusProductos" data-parsley-required="true">
                                                                    <option value="">Selecciona . . .</option>
                                                                    ` +
                                                                    _optionsEstatus +
                                                                    `
                        ...
                        tabla.generaTablaPersonal(
                                "#data-table-inventario-sala4d-elementos",
                                null,
                                null,
                                true
                                );
                        tabla.generaTablaPersonal(
                                "#data-table-inventario-sala4d-subelementos",
                                null,
                                null,
                                true
                                );
    ...
    function formaularioCambiarEstatus(estatus, idInventario, idAlmacenVirtual) {
        let html = `<div class="row">
                        <div class="col-md-12">
                            <div class="form-grup">
                                <label class="f-w-600">Estatus</label>
                                <select id="estatusAlmacenVirtual" class="form-control" style="width: 100% !important;">
                    ...
                    <div class="row m-t-15">
                       <div class="col-md-12">
                            <div id="errorEstatusAlmacenVirtual"></div>
                        </div>
                    </div>`;

        evento.mostrarModal("Cambiar estatus", html);
        select.crearSelect("#estatusAlmacenVirtual");

        $.each(estatus, function (key, valor) {
            $("#estatusAlmacenVirtual").append(
        ...
        $("#btnModalConfirmar").off("click");
        $("#btnModalConfirmar").on("click", function () {
            let idEstatus = $('#estatusAlmacenVirtual').val();

            if (idEstatus !== '') {
                evento.enviarEvento("Catalogo/CambiarEstatus", {idInventario: idInventario, idEstatus: idEstatus, idAlmacenVirtual: idAlmacenVirtual}, "#modal-dialogo", function (respuesta) {
                    if (respuesta.code === 200) {
                        ...
                        evento.cerrarModal();
                        evento.mostrarMensaje("#errorInventarioAlmacen", true, "Se actulizo correctamente la información.", 4000);
                    } else {
                        evento.mostrarMensaje("#errorEstatusAlmacenVirtual", false, "Te falta seleccionar el estatus.", 3000);
                    }
                });
            } else {
                evento.mostrarMensaje("#errorEstatusAlmacenVirtual", false, "Te falta seleccionar el estatus.", 3000);
    ...
    function revisaSeriesDuplicadas() {
        ...
        evento.enviarEvento(
                "Catalogo/RevisaSeriesDuplicadas",
                datos,
                "#panelAgregarProducto",
                function (respuesta) {
                    ...
                    if (seriesDuplicadas.length > 0) {
                        var html =
                                '<h4 class="text-center">Las siguientes series ya se encuentran registradas en el sistema.\nPor favor corrija la información.</h4><h5 class="bg-warning"><ul>';
    ...
    function saveProducts() {
        ...
        if (data.length > 0) {
            ...
            evento.enviarEvento(
                    "Catalogo/GuardarProductosInventario",
                    datos,
                    "#panelAgregarProducto",
                    function (respuesta) {
                        if (respuesta.estatus == 200) {
                            if (SAE) {
                                ...
                                $.each(respuesta.otros, function (k, v) {
                                    tabla.agregarFila("#data-table-otros", [
                                        v.Id,
                                        v.Producto,
                                        v.Tipo,
                                        v.Cantidad,
                                ...
                                $.each(respuesta.salas, function (k, v) {
                                    tabla.agregarFila("#data-table-salas", [
                                        v.Id,
                                        v.Producto,
                                        v.Tipo,
                                        v.Cantidad,
    ...
    function initTraspaso() {
        $("#listAlmacenOrigen").on("change", function () {
            ...
            if (_origen != "") {
                ...
                evento.enviarEvento(
                        "Catalogo/MostrarProductosTraspaso",
                        data,
                        "#panelTraspaso",
                        function (respuesta) {
                            $("#divProductosTraspaso")
                            ...
                            $("#data-table-inventario-otros tbody").on(
                                    "click",
                                    "tr",
                                    function () {
                                        var _dataId = $(this).attr("data-id");
                            ...
                            $("#btnTraspasar").on("click", function () {
                                ...
                                if (
                                        productoTraspasar.equipos.length > 0 ||
                                        productoTraspasar.otros.length > 0
                                        ) {
                                    if (
                                            $("#listAlmacenOrigen").val() != "" &&
                                            $("#listAlmacenDestino").val() != ""
                                            ) {
                                        var data = {
                                                ...
                                                function (respuesta) {
                                                    if (respuesta.estatus) {
                                                        ...
                                                        evento.mostrarMensaje(
                                                                "#errorTraspasar",
                                                                false,
                                                                "No se pudo registrar el traspaso. Intente de nuevo o recargue su página.",
                                                                4000
                                                                );
                                                    }
                                                }
                                        ...
                                        evento.mostrarMensaje(
                                                "#errorTraspasar",
                                                false,
                                                "Debe seleccionar un almacén de Origen y un almacén Destino.",
                                                4000
                                                );
                                    }
                                } else {
                                    evento.mostrarMensaje(
                                            "#errorTraspasar",
                                            false,
                                            "No se han seleccionaro productos para traspasar.",
                                            4000
                                            );
                                }
                            });
    ...
    function initVerTraspasos() {
        ...
        $("#data-table-traspasos tbody").on("click", "tr", function () {
            var datos = $("#data-table-traspasos")
                    .DataTable()
                    .row(this)
                    .data();
            var data = {
    ...
    function initVerAltasIniciales() {
        ...
        $("#data-table-altas-iniciales tbody").on("click", "tr", function () {
            var datos = $("#data-table-altas-iniciales")
                    .DataTable()
                    .row(this)
                    .data();
            var data = {
    ...
    function initVerKitsEquipos() {
        ...
        $("#data-table-kits-equipos tbody").on("click", "tr", function () {
            var datos = $("#data-table-kits-equipos")
                    .DataTable()
                    .row(this)
                    .data();
            var data = {
            ...
            $("#mainTitle")
                    .empty()
                    .append("Editar Kit de Equipo");
            $("#panelAgregarEditarKit .panel-title")
                    .empty()
                    .append("Editar Kit de Equipo");
            $("#mainTitleBody")
                    .empty()
        ...
        $("#btnAgregarKitEquipo").on("click", function () {
            $("#mainTitle")
                    .empty()
                    .append("Agregar Kit de Equipo");
            $("#panelAgregarEditarKit .panel-title")
                    .empty()
                    .append("Agregar Kit de Equipo");
            $("#mainTitleBody")
                    .empty()
                    .append("Agregar nuevo Kit de Equipo");
        ...
        $("#listEquiposKit").on("change", function () {
            ...
            if (_modelo == "") {
                ...
                evento.enviarEvento(
                        "Catalogo/MostrarComponentesEquipoKit",
                        data,
                        "#panelAgregarEditarKit",
                        function (respuesta) {
                            $("#div-table-componentes-kit")
                                    .empty()
                                    .append(respuesta.html);
                            tabla.generaTablaPersonal(
                                    "#data-table-componentes-kit",
                                    null,
                                    null,
                                    true,
                                    false,
                                ...
                                $(".cantidad-componente-kit").each(function (k, v) {
                                    ...
                                    if (!isNaN(_cantidadComponente) && _cantidadComponente > 0) {
                                        arrayComponentes.push(
                                                $(this).attr("data-id") + "_" + _cantidadComponente
                                                );
                                    }
                                });
