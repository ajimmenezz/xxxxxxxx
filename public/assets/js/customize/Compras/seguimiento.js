$(function () {
    ...
    tabla.generaTablaPersonal('#data-table-compras', null, null, true, true, [[0, 'desc']]);
    ...
    $('#data-table-compras tbody').on('click', 'tr', function () {
        var datos = $('#data-table-compras').DataTable().row(this).data();
        if (datos !== undefined) {
            ...
            if (operacion === '1') {
                ...
                $('#btnIniciarServicio').on('click', function () {
                    ...
                    evento.enviarEvento('Seguimiento/Servicio_Datos', data, '#modal-dialogo', function (respuesta) {
                        ...
                        recargandoTablaCompras(respuesta.informacion);
                    });
                });
    ...
    var recargandoTablaCompras = function (informacionServicio) {
        tabla.limpiarTabla('#data-table-compras');
