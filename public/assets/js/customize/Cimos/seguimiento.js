$(function () {
    ...
    tabla.generaTablaPersonal('#data-table-cimos', null, null, true, true, [[0, 'desc']]);
    ...
    $('#data-table-cimos tbody').on('click', 'tr', function () {
        var datos = $('#data-table-cimos').DataTable().row(this).data();
        if (datos !== undefined) {
