...
function cargarFormularioSeguimiento() {
    ...
    evento.enviarEvento("Seguimiento/Servicio_Datos", data, panel, function(
      ...
      if (datosDelServicio.tieneSeguimiento === "0") {
        ...
        switch (datosDelServicio.IdTipoServicio) {
          ...
          case "12":
            iniciarElementosPaginaSeguimientoMantenimiento(
              respuesta,
              datosTabla
            );
          ...
          case "27":
            ...
            initDeviceTransferAndDeviceRequest(datosTabla[0]);
            break;
          //Servicio Checklist
          //                    case '27':
        ...
        evento.enviarEvento(
          ...
          function(respuesta) {
            if (respuesta.sucursal) {
              ...
              evento.mostrarMensaje(
                "#errorInformacionGeneral",
                false,
                "Tienes informacion incompleta",
                3000
              );
            }
          }
  ...
  function concluirServicioChecklist() {
    ...
    evento.mostrarModal(
      "Firma",
      servicios.modalCampoFirmaExtra(htmlFirmaExtra, "Firma")
    );
    ...
    $("#btnGuardarFirma").on("click", function() {
      ...
      var imgInputTecnico =
        myBoardTecnico.blankCanvas == imgTecnico ? "" : imgTecnico;
      ...
      if (personaRecibe !== "") {
        if (correo.length > 0) {
          if (servicios.validarCorreoArray(correo)) {
            if (imgInput !== "") {
              if (imgInputTecnico !== "") {
                if ($("#terminos").attr("checked")) {
                  var dataInsertar = {
                    ...
                    servicio: servicio,
                    img: img,
                    imgFirmaTecnico: imgTecnico,
                    correo: correo,
                    recibe: personaRecibe,
                    sucursal: sucursal
                  };
                  evento.enviarEvento(
                    ...
                    function(respuesta) {
                      if (respuesta) {
                        ...
                        evento.mostrarMensaje(
                          ".errorFirma",
                          false,
                          "Tienes informacion sin concluir",
                          3000
                        );
                      }
                    }
                ...
                evento.mostrarMensaje(
                  ".errorFirma",
                  false,
                  "Debes llenar el campo Firma del Técnico.",
                  3000
                );
              }
            } else {
              evento.mostrarMensaje(
                ".errorFirma",
                false,
                "Debes llenar el campo Firma del gerente de conformidad.",
                3000
              );
            }
          } else {
          ...
          evento.mostrarMensaje(
            ".errorFirma",
            false,
            "Debe insertar al menos un correo.",
            3000
          );
        }
      } else {
        evento.mostrarMensaje(
          ".errorFirma",
          false,
          "Debe escribir el nombre del gerente.",
          3000
        );
      }
    });
  ...
  function mostrarTabla(sucursal, respuesta, datosTabla) {
    ...
    $('#tab-checklist > li > a[href="#revisionPunto"]').attr(
      "data-toggle",
      "tab"
    );
    ...
    $('#tab-checklist > li > a[href="#revisionTecnica"]').attr(
      "data-toggle",
      "tab"
    );
  };
    ...
    evento.enviarEvento(
      ...
      function(respuesta) {
        ...
        $("#selectComponenteDiagnosticoCorrectivo").on("change", function() {
          ...
          $("#selectTipoFallaComponenteCorrectivo")
            .empty()
            .append('<option value="">Seleccionar</option>')
            .attr("disabled", "disabled");
          ...
          if (_componente !== "") {
            evento.enviarEvento(
              ...
              function(respuesta) {
                ...
                if (respuesta.length > 0) {
                  $("#selectTipoFallaComponenteCorrectivo").removeAttr(
                    "disabled"
                  );
                }
              }
        ...
        $("#selectTipoFallaComponenteCorrectivo").on("change", function() {
          ...
          $("#selectFallaComponenteDiagnosticoCorrectivo")
            .empty()
            .append('<option value="">Seleccionar</option>')
            .attr("disabled", "disabled");
          select.cambiarOpcion(
        ...
        $("#btnGuardarImpericiaChecklist").on("click", function() {
          ...
          var idFalla = $(
            "#selectImpericiaFallaDiagnosticoCorrectivo option:selected"
          ).val();
        ...
        $("#btnGuardarFallaEquipoChecklist").on("click", function() {
          ...
          var idFalla = $(
            "#selectFallaDiagnosticoCorrectivo option:selected"
          ).val();
        ...
        $("#btnGuardarFallaComponenteChecklist").on("click", function() {
          ...
          var tipoFalla = $(
            "#selectTipoFallaComponenteCorrectivo option:selected"
          ).val();
          var idFalla = $(
            "#selectFallaComponenteDiagnosticoCorrectivo option:selected"
          ).val();
          ...
          evento.enviarEvento(
            ...
            function(respuestaRevision) {
              ...
              $("#editarEstatus").on("click", function() {
                ...
                var datos = {
                  idRevisionTecnica: dato.idRevisionTecnica,
                  servicio: servicio,
                  estatusRevision: estatusRevision
                };
                evento.enviarEvento(
  ...
  function initDiagnosticoEquipo() {
    ...
    $("#selectTipoFallaEquipoCorrectivo")
      ...
      .append('<option value="">Seleccionar</option>')
      .attr("disabled", "disabled");
    $("#selectComponenteDiagnosticoCorrectivo")
      .empty()
      .append('<option value="">Seleccionar</option>')
      .attr("disabled", "disabled");
    switch (_tab) {
  ...
  function guardarRevisionTecnicaChecklist() {
    ...
    if (datos.idFalla !== "" && datos.tipoFalla && _evidencia !== "") {
      ...
      evento.mostrarMensaje(
        "#errorRevisionTecnica",
        false,
        "No se a podido guardar la información. Intente de nuevo o contacte al administrador",
        3000
      );
    }
  };
  ...
  function mostrarPreguntaPorCategoria(
    dataCategoria,
    sucursal,
    respuesta
  ) {
          ...
          $.each(lista, function(clave, valor) {
            if (valor.IdArea) {
              var decicionUno =
                ...
                valor.IdArea +
                '"><input type="radio" id="uno" name="desicion-' +
                valor.IdArea +
                '" value="1" style="height: 16px;width: 20px;margin: 0px 5px 0px 5px;"/><spam style="margin: 0 11px 0 0px;">Si</spam> <input type="radio" name="desicion-' +
                valor.IdArea +
                '" id="cero" value="0" style="height: 15px;width: 17px;margin: 0px 5px 0px 5px;"/><spam style="margin: 0 11px 0 0px;">No</spam> </fieldset></form>';
  ...
  function mostrarPuntoPorCategoria(
    dataCategoria,
    sucursal,
    respuesta,
    datosTabla
  ...
  function imprimirAreaPregunta(area, pregunta, html) {
    ...
    $.each(pregunta, function(etiqueta, listaPuntos) {
      html +=
        '<div class="m-t-30"><p>' +
        area +
        '</p><div class="underline m-b-15"></div><p>' +
        etiqueta +
        "</p>";
      puntos = listaPuntos;
    });
  ...
  function cargarEvidencias(
    ...
    $.each(checkList, function(index, checked) {
      ...
      if (
        area === idArea &&
        checked.IdCategoria === `${categoria}` &&
        checked.Punto === punto &&
        checked.Evidencia !== ""
      ) {
        html += obtenerHtmlEvidencias(
          checked.Evidencia,
          idImagen,
          punto,
          servicio,
  ...
  function obtenerHtmlEvidencias(
    evidencias,
    idImagen,
    punto,
    servicio,
      ...
      function(respuesta) {
        $.each(respuesta, function(key, valor) {
          if (dataCategoria == valor.IdCategoria) {
            if (valor.Flag === `1`) {
              var $radios = $(
                "#group-" + valor.IdAreaAtencion + " input:radio[id=uno]"
              );
              $radios.filter("[value=1]").attr("checked", true);
            } else {
              var $radios = $(
                "#group-" + valor.IdAreaAtencion + " input:radio[id=cero]"
              );
  ...
  function iniciarElementosPaginaSeguimientoCenso() {
    ...
    tabla.generaTablaPersonal(
      "#data-table-documetacion-firmada",
      respuesta.documentacionFirmada,
      columnas,
      null,
      null,
      [[0, "desc"]]
            ...
            function(respuesta) {
              ...
              $(".existeModelosEstandar").on("click", function() {
                ...
                if ($(this).is(":checked")) {
                  ...
                  fila
                    .removeClass("table-border-red")
                    .addClass("table-border-green");
                } else {
                  ...
                  fila
                    .removeClass("table-border-green")
                    .addClass("table-border-red");
                }
              });
              ...
              $("#listModelosEquipoAdicional").on("change", function() {
                ...
                if ($("#txtEtiquetaEquipoAdicional").length) {
                  ...
                  if ($("#listModelosEquipoAdicional").val() != "") {
                    ...
                    $("#txtEtiquetaEquipoAdicional").attr(
                      "disabled",
                      "disabled"
                    );
                  }
                  ...
                  if (modelo.indexOf("COMPUTADORA") >= 0) {
                    ...
                    $("#txtNombreRedEquipoAdicional").attr(
                      "disabled",
                      "disabled"
                    );
              ...
              $(".listModelosEquiposAdicionales").on("change", function() {
                ...
                if (fila.find(".macEquiposAdicionales").length) {
                  ...
                  var campoNombreRed = fila.find(
                    ".nombreRedEquiposAdicionales"
                  );
                  ...
                  if (fila.hasClass("registroNuevo")) {
                    ...
                    if (checkExiste.is(":checked")) {
                      var datosEquipo = {
                        ...
                        ilegible: fila
                          .find(".ilegibleModelosEstandar")
                          .is(":checked")
                          ? 1
                          : 0,
                        existe: 1,
                        danado: fila
                          .find(".danadoModelosEstandar")
                          .is(":checked")
                          ? 1
                          : 0
                      };
                      if (datosEquipo.modelo == "") {
                        evento.mostrarMensaje(
                          ".divErrorCapturaCensoEstandar",
                          false,
                          "Falta seleccionar el modelo en alguno de sus registros. Desmarque la casilla 'Existe' en caso de que el equipo no exista",
                          6000
                        );
                        return true;
                      }
                      ...
                      if (
                        datosEquipo.serie == "" &&
                        datosEquipo.ilegible == 0
                      ) {
                        evento.mostrarMensaje(
                          ".divErrorCapturaCensoEstandar",
                          false,
                          "Falta el número de serie en alguno de sus registros. Marque la casilla 'Ilegible' en caso de que la serie no sea alcanzable o no se encuentre en el equipo.",
                          6000
                        );
                        return true;
                      }
                    ...
                    var datosEquipo = {
                      ...
                      ilegible: fila
                        ...
                        ? 1
                        : 0,
                      existe: fila.find(".existeModelosEstandar").is(":checked")
                        ? 1
                        : 0,
                      danado: fila.find(".danadoModelosEstandar").is(":checked")
                        ? 1
                        : 0
                    };
                  ...
                  function(respuesta) {
                    if (respuesta.code == 200) {
                      ...
                      evento.mostrarMensaje(
                        ".divErrorCapturaCensoEstandar",
                        false,
                        "Ocurrió un error al guardar los registros. Por favor contácte al administrador.",
                        6000
                      );
                    }
                  }
              ...
              $("#btnAgregarEquipoAdicional").on("click", function() {
                data = {
                  ...
                  ilegible: $("#checkIlegibleEquipoAdicional").is(":checked")
                    ? 1
                    : 0,
                  danado: $("#checkDanadoEquipoAdicional").is(":checked")
                    ? 1
                    : 0,
                  etiqueta: $("#txtEtiquetaEquipoAdicional").length
                    ? $("#txtEtiquetaEquipoAdicional").val()
                    : "",
                  estado: $("#listEstadosEquipoAdicional").length
                    ? $("#listEstadosEquipoAdicional").val()
                    : "",
                  mac: $("#txtMACEquipoAdicional").length
                    ? $("#txtMACEquipoAdicional").val()
                    : "",
                  so: $("#listSOEquipoAdicional").length
                    ? $("#listSOEquipoAdicional").val()
                    : "",
                  nombreRed: $("#txtNombreRedEquipoAdicional").length
                    ? $("#txtNombreRedEquipoAdicional").val()
                    : "",
                  rq: $("#listRQEquipoAdicional").length
                    ? $("#listRQEquipoAdicional").val()
                    : ""
                };
                ...
                if (data.modelo == "") {
                  evento.mostrarMensaje(
                    ...
                    false,
                    "Falta seleccionar el modelo para agregar el equipo.",
                    4000
                  );
                  return true;
                }
                ...
                if (data.serie == "" && data.ilegible == 0) {
                  evento.mostrarMensaje(
                    ".divErrorEquipoAdicional",
                    false,
                    "Falta el número de serie. Marque la casilla 'Ilegible' en caso de que la serie no sea alcanzable o no se encuentre en el equipo.",
                    6000
                  );
                  return true;
                }
                ...
                if ($("#txtEtiquetaEquipoAdicional").length) {
                  ...
                  if (
                    data.etiqueta == "" ||
                    !regexEtiqueta.test(data.etiqueta)
                  ) {
                    evento.mostrarMensaje(
                      ".divErrorEquipoAdicional",
                      false,
                      "Al parecer hay un error con el formato de la etiqueta.",
                      6000
                    );
                    return true;
                  }
                  ...
                  if (data.estado == "") {
                    evento.mostrarMensaje(
                      ".divErrorEquipoAdicional",
                      false,
                      "Falta seleccionar el estado del equipo.",
                      6000
                    );
                    return true;
                  }
                  ...
                  if (data.modeloTexto.indexOf("COMPUTADORA") >= 0) {
                    ...
                    if (data.mac == "" || !regexMacAddress.test(data.mac)) {
                      evento.mostrarMensaje(
                        ".divErrorEquipoAdicional",
                        false,
                        "Al parecer hay un error con el formato de la MAC Address",
                        6000
                      );
                      return true;
                    }
                    ...
                    if (data.so == "") {
                      evento.mostrarMensaje(
                        ".divErrorEquipoAdicional",
                        false,
                        "Falta seleccionar el S.O. del equipo.",
                        6000
                      );
                      return true;
                    }
                    if (data.nombreRed == "") {
                      evento.mostrarMensaje(
                        ".divErrorEquipoAdicional",
                        false,
                        "Al parecer falta el nombre de red para el equipo.",
                        6000
                      );
                      return true;
                    }
                    ...
                    if (data.rq == "") {
                      evento.mostrarMensaje(
                        ".divErrorEquipoAdicional",
                        false,
                        "Falta seleccionar el estatus del software RQ",
                        6000
                      );
                      return true;
                    }
                  ...
                  function(respuesta) {
                    if (respuesta.code == 200) {
                      ...
                      evento.mostrarMensaje(
                        ".divErrorEquipoAdicional",
                        false,
                        "Ocurrió un error al eliminar el equipo. Por favor contácte al administrador.",
                        6000
                      );
                    }
                  }
              ...
              $(".btnGuardarCambiosEquiposAdicionalesCenso").on(
                ...
                function() {
                  ...
                  data = {
                    ...
                    modeloTexto: fila
                      .find(".listModelosEquiposAdicionales option:selected")
                      .text(),
                    serie: fila.find(".serieEquiposAdicionales").val(),
                    ilegible: fila
                      .find(".ilegibleEquiposAdicionales")
                      .is(":checked")
                      ? 1
                      : 0,
                    existe: 1,
                    danado: fila
                      .find(".danadoEquiposAdicionales")
                      .is(":checked")
                      ? 1
                      : 0,
                    etiqueta: fila.find(".etiquetaEquiposAdicionales").length
                      ? fila.find(".etiquetaEquiposAdicionales").val()
                      : "",
                    estado: fila.find(".listEstadosEquiposAdicionales").length
                      ? fila.find(".listEstadosEquiposAdicionales").val()
                      : "",
                    mac: fila.find(".macEquiposAdicionales").length
                      ? fila.find(".macEquiposAdicionales").val()
                      : "",
                    so: fila.find(".listSOEquiposAdicionales").length
                      ? fila.find(".listSOEquiposAdicionales").val()
                      : "",
                    nombreRed: fila.find(".nombreRedEquiposAdicionales").length
                      ? fila.find(".nombreRedEquiposAdicionales").val()
                      : "",
                    rq: fila.find(".listRQEquiposAdicionales").length
                      ? fila.find(".listRQEquiposAdicionales").val()
                      : ""
                  };
        ...
        $("#btnAgregarAreaPuntos").on("click", function() {
          ...
          if (data.area == "" || parseInt(data.puntos) <= 0) {
            evento.mostrarMensaje(
              ".divError",
              false,
              "El área y puntos son obligatorios",
              4000
            );
          } else {
            evento.enviarEvento(
  ...
  function eventosParaSeccionSeguimientoCenso() {
    ...
    $("#btnGuardarServicioCenso").on("click", function(e) {
      ...
      if (datosTablaModelos.length > 0) {
        ...
        evento.mostrarMensaje(
          ".errorDatosCenso",
          false,
          "Para guardar los Censos debe haber agregado un registro en la tabla un Censo.",
          3000
        );
      }
    });
    ...
    if (respuesta.informacionDatosGenerales.length > 0) {
      servicios.initDocumentacionFirma(
        servicio,
        datosTabla[7],
        respuesta.informacionDatosGenerales[0].IdSucursal
      );
    }
  ...
  function personalizarDependiendoSucursalCenso() {
    ...
    if (respuesta.informacionDatosGenerales.length > 0) {
      ...
      if (respuesta.datosServicio.IdSucursal !== null) {
        select.cambiarOpcion(
          "#selectSucursales",
          respuesta.datosServicio.IdSucursal
        );
      }
    }
  };
  ...
  function guardarFormularioDatosGeneralesCenso() {
    ...
    if (sucursal !== "" && descripcion !== "") {
      ...
      evento.mostrarMensaje(
        ".errorDatosGeneralesCenso",
        false,
        "Debes llenar todos los campos para poder guardar la información",
        3000
      );
    }
  };
    ...
    if (
      ...
      if (punto > 0) {
        ...
        evento.mostrarMensaje(
          ".errorDatosCenso",
          false,
          "Debes colocar un número positivo en el campo Punto.",
          3000
        );
      }
    } else {
      evento.mostrarMensaje(
        ".errorDatosCenso",
        false,
        "Debes llenar todos los campos para poder agregar el Equipo.",
        3000
      );
    }
  };
  function validarCensoEnTabla() {
    ...
    if (filas.length > 0) {
      for (var i = 0; i < filas.length; i++) {
        if (
          $.trim(filas[i][0]) === nombreAreaAtencion &&
          $.trim(filas[i][1]) === punto &&
          $.trim(filas[i][3]) === serie
        ) {
          repetidoSerie = true;
        }
      }
    ...
    if (!repetidoSerie) {
      ...
      evento.mostrarMensaje(
        ".errorDatosCenso",
        false,
        "Ya se agregó la Serie a esa Área de Atención y Punto, favor de eliminar el que esta registrado si quiere actualizarlo",
        4000
      );
    }
  };
      ...
      function(respuesta) {
        if (respuesta instanceof Array) {
          ...
          evento.mostrarMensaje(
            ".errorDatosCenso",
            false,
            "No se pudo guardar el Censo por favor de volver a intentarlo.",
            3000
          );
        }
      }
  ...
  function guardarCambiosConcluirServicioCenso() {
    ...
    var data = {
      ...
      ticket: datosTablaPoliza[1],
      idSolicitud: datosTablaPoliza[2],
      seccion: "#seccion-servicio-censo"
    };
  ...
  function eliminarFilaTablaModelos() {
    ...
    $("#btnAceptarGuardarCambios").on("click", function() {
      ...
      var dataCensos = {
        servicio: servicio,
        serie: datosTablaCensoModelos[0][3],
        numeroTerminal: datosTablaCensoModelos[0][4]
      };
      evento.enviarEvento(
        ...
        function(respuesta) {
          if (!respuesta || respuesta instanceof Object) {
            ...
            evento.mostrarMensaje(
              ".errorDatosCenso",
              false,
              "No se pudo eliminar el Censo por favor de volver a intentarlo.",
              3000
            );
          }
        }
    ...
    $.each(respuesta, function(key, valor) {
      tabla.agregarFila(
        ...
        [
          valor.Sucursal,
          valor.Punto,
          valor.Linea + " - " + valor.Marca + " - " + valor.Modelo,
          valor.Serie,
          valor.Extra,
          valor.IdArea,
          valor.IdModelo
  ...
  function iniciarElementosPaginaSeguimientoMantenimiento() {
    ...
    tabla.generaTablaPersonal(
      "#data-table-documetacion-firmada",
      respuesta.informacion.documentacionFirmada,
      columnas,
      null,
      null,
      [[0, "desc"]]
    ...
    file.crearUpload(
      "#evidenciasProblemasAdicionales",
  ...
  function eventosParaSeccionSeguimientoMantenimiento() {
    ...
    $("#data-table-puntos-censados tbody").on("click", "tr", function() {
      var datosTablaPuntosCensado = $("#data-table-puntos-censados")
        ...
        .rows(this)
        .data();
      mostrarFormularioAntesYDespues(
        datosTablaPuntosCensado,
        servicio,
        datosTablaPoliza
      );
    });
    ...
    if (respuesta.informacion.idSucursal !== undefined) {
      servicios.initDocumentacionFirma(
        servicio,
        datosTablaPoliza[7],
        respuesta.informacion.idSucursal
      );
    }
    servicios.initBotonReasignarServicio(
      servicio,
        ...
        function(respuesta) {
          if (respuesta instanceof Array) {
            ...
            evento.mostrarMensaje(
              ".errorDatosMantenimiento",
              false,
              "No hay un Censo leventado en esa Sucursal.",
              3000
            );
          }
        }
  ...
  function personalizarDependiendoSucursalMantenimiento() {
    ...
    if (
      ...
      select.cambiarOpcion(
        "#selectSucursalesMantenimiento",
        respuesta.informacion.informacionDatosGeneralesMantenimiento[0]
          .IdSucursal
      );
      datosMostrarSucursalGuardada();
    } else {
  ...
  function validarFormularioProblemasAdicionales() {
    ...
    if (areaAtencion !== "" || areaYPunto !== "") {
      if (descripcion !== "") {
        if (evidencias !== "") {
          ...
          evento.mostrarMensaje(
            ...
            false,
            "Debes seleccionar una imagen del problema.",
            3000
          );
        }
      } else {
        evento.mostrarMensaje(
          ".errorFormularioProblemasAdicionales",
          false,
          "Debes escribir una descripción del problema.",
          3000
        );
      }
    } else {
      evento.mostrarMensaje(
        ".errorFormularioProblemasAdicionales",
        false,
        "Debes de seleccionar el campo del Área del problema.",
        3000
      );
    }
  };
  function guardarFormularioProblemasAdicionales() {
    ...
    var data = {
      servicio: servicio,
      area: arrayFormularioProblemasAdionales[0][3],
      punto: arrayFormularioProblemasAdionales[0][1],
      descripcion: arrayFormularioProblemasAdionales[0][2]
    };
    file.enviarArchivos(
      "#evidenciasProblemasAdicionales",
      "Seguimiento/guardarProblemasAdicionales",
      ...
      function(respuesta) {
        if (respuesta instanceof Array) {
          ...
          evento.mostrarMensaje(
            ".errorFormularioProblemasAdicionales",
            false,
            "No se pudo agregar el Problema Adicional por favor de volver a intentarlo.",
            3000
          );
        }
      }
  ...
  function agregandoProblemasAdicionalesArreglo() {
    ...
    var nombreAreaAtencion = $(
      "#selectAreasAtencionProblemasAdicionales option:selected"
    ).text();
    var areaYPunto = $("#selectAreaPuntoProblemasAdicionales").val();
    var nombreAreaYPunto = $(
      "#selectAreaPuntoProblemasAdicionales option:selected"
    ).text();
    ...
    if (areaYPunto !== "") {
      var nombreAreaYPunto = nombreAreaYPunto.substring(
        0,
        nombreAreaYPunto.indexOf(" ") + 2
      );
  ...
  function mostrarFormularioAntesYDespues() {
    ...
    var dataTabla = {
      servicio: servicio,
      area: datosTablaPuntosCensados[0][3],
      punto: datosTablaPuntosCensados[0][1],
      servicioCenso: datosTablaPuntosCensados[0][4],
      modelo: datosTablaPuntosCensados[0][5],
      serie: datosTablaPuntosCensados[0][6]
    };
    evento.enviarEvento(
  ...
  function eventosAntesYDespues() {
    ...
    $("#btnGuardarAntes").on("click", function(e) {
      if (
        validarCampos(
          ...
          ".errorFormularioAntes",
          "Debes llenar el campo de Observaciones."
        )
      ) {
        guardarFormularioAntesYDespues(
          datosTablaPuntosCensados,
          servicio,
          "Antes",
          sucursal
    ...
    $("#selectEquipoAntesYDespues").on("change", function() {
      ...
      var modelo = $("#selectEquipoAntesYDespues option:selected").attr(
        "value"
      );
      if (
        $("#selectEquipoAntesYDespues option:selected").text() === "Seleccionar"
      ) {
        $("#datosProblemaEquipo").addClass("hidden");
      }

      file3.crearUpload(
        "#evidenciasFallasEquipo",
    ...
    $("#selectEquipoRefaccionAntesDespues").on("change", function() {
      ...
      select.setOpcionesSelect(
        "#selectRefaccionAntesDespues",
        objetoNuevoComponentesEquipo,
        $("#selectEquipoRefaccionAntesDespues").val(),
        "IdMod"
      );
    ...
    $("#btnGuardarTablaEquiposMantenimiento").on("click", function(e) {
      var datosTablaModelos = $("#data-table-equipos-faltantes")
        ...
        .data();
      if (datosTablaModelos.length > 0) {
        guardarDatosTablaEquipoFaltante(
          datosTablaModelos,
          servicio,
          datosTablaPoliza,
          sucursal,
        ...
        evento.mostrarMensaje(
          ".errorTablaEquipoFaltante",
          false,
          "Para guardar los Equipos faltantes debe haber agregado un registro en la tabla.",
          4000
        );
      }
    });
    $("#data-table-equipos-faltantes tbody").on("click", "tr", function() {
      var datosTablaEquiposFaltantes = $("#data-table-equipos-faltantes")
        ...
        .rows(this)
        .data();
      eliminarFilaTablaEquiposFaltantes(
        datosTablaEquiposFaltantes,
        servicio,
        datosTablaPuntosCensados
      );
    });
  ...
  function guardarFormularioFallasEquipo() {
    ...
    if (descripcion !== "") {
          ...
          if (respuesta !== "existeRegistro") {
            if (respuesta !== "faltaEvidencia") {
              ...
              evento.mostrarMensaje(
                "#errorFallasEquipo",
                false,
                "Falta seleccionar un Archivo o Evidencia.",
                3000
              );
            }
          } else {
            evento.mostrarMensaje(
              "#errorFallasEquipo",
              false,
              "Ya se agrego un problema a ese equipo.",
              3000
            );
          }
        }
      ...
      evento.mostrarMensaje(
        "#errorFallasEquipo",
        false,
        "Debes llenar el campo de Observaciones del Problema.",
        3000
      );
    }
  };
    ...
    if (selectUtilizado !== "") {
      switch (nombreCampo) {
        case "equipo":
          ...
          var nombreEquipo = $(
            "#selectEquipoAnteDespues option:selected"
          ).text();
          if (selectEquipo !== "") {
            if (cantidadEquipo > 0) {
              var data = {
              ...
              evento.mostrarMensaje(
                ".errorFormularioEquipoFaltante",
                false,
                "Debes llenar el campo de Cantidad con un número positivo.",
                3000
              );
            }
          } else {
        ...
        case "material":
          ...
          var cantidadMaterial = $(
            "#inputMaterialEquipoFaltanteCantidad"
          ).val();
          var nombreMaterial = $(
            "#selectMaterialAntesDespues option:selected"
          ).text();
          if (selectMaterial !== "") {
        ...
        case "refaccion":
          ...
          var cantidadRefaccion = $(
            "#inputRefaccionEquipoFaltanteCantidad"
          ).val();
          var nombreRefaccion = $(
            "#selectRefaccionAntesDespues option:selected"
          ).text();
          if (selectEquipo !== "") {
            if (selectRefaccion !== "") {
              if (cantidadRefaccion > 0) {
                var data = {
                  tipoItem: "3",
                  item: selectRefaccion,
                  cantidad: cantidadRefaccion,
                  nombre: nombreRefaccion
                };
              ...
              evento.mostrarMensaje(
                ".errorFormularioEquipoFaltante",
                false,
                "Debes Selecionar una Refacción.",
                3000
              );
            }
          } else {
      ...
      evento.mostrarMensaje(
        ".errorFormularioEquipoFaltante",
        false,
        "Debes Selecionar un Equipo o Material.",
        3000
      );
    }
  };
  function validarEquipoFaltanteEnTabla() {
    ...
    if (!repetido) {
      ...
      evento.mostrarMensaje(
        ".errorFormularioEquipoFaltante",
        false,
        "Ya se agrego el Material o Equipo",
        3000
      );
    }
  };
  ...
  function eliminarFilaTablaEquiposFaltantes() {
    ...
    $("#btnAceptarGuardarCambios").on("click", function() {
      ...
      var dataEquiposFaltantes = {
        ...
        area: datosTablaPuntosCensados[0][3],
        punto: datosTablaPuntosCensados[0][1],
        modelo: datosTablaEquiposFaltantes[0][3],
        tipoItem: datosTablaEquiposFaltantes[0][4]
      };
      evento.enviarEvento(
        ...
        function(respuesta) {
          if (respuesta instanceof Array) {
            ...
            evento.mostrarMensaje(
              ".errorTablaEquipoFaltante",
              false,
              "No se puede eliminar este registro hasta que presione el botón de Guardar Tablas de Equipos.",
              5000
            );
          } else {
            recargandoTablaEquiposFaltantes(
      ...
      function(respuesta) {
        if (respuesta !== "faltaDocumentacion") {
          ...
          evento.mostrarMensaje(
            ".errorDatosMantenimiento",
            false,
            "Favor de Documentar todos los Puntos Censados en la Sección Antes y Después.",
            5000
          );
        }
      }
      ...
      function(respuesta) {
        if (respuesta !== "faltaDocumentacion") {
          var datavalicacion = {
            ...
            sucursal: sucursal,
            operacion: "3",
            seccion: "#seccion-servicio-mantemiento"
          };
          servicios.validarTecnicoPoliza();
  ...
  function iniciarElementosPaginaSeguimientoCorrectivo() {
    ...
    tabla.generaTablaPersonal(
      "#data-table-reparacion-refaccion-stock",
      null,
      null,
      true,
      true,
    ...
    tabla.generaTablaPersonal(
      "#data-table-reparacion-cambio-stock",
      null,
      null,
      true,
      true,
        ...
        switch (respuesta.informacion.diagnosticoEquipo[0].IdTipoDiagnostico) {
          case "1":
            evidenciaReporteFalso =
              respuesta.informacion.evidenciasDiagnosticoEquipo;
            break;
          case "2":
            evidenciaImpericia =
              respuesta.informacion.evidenciasDiagnosticoEquipo;
        ...
        switch (respuesta.informacion.correctivosSoluciones[0].IdTipoSolucion) {
          case "1":
            evidenciaReparacionSinEquipo =
              respuesta.informacion.evidenciasCorrectivosSoluciones;
            break;
          case "2":
    ...
    console.log(evidenciaImpericia);
    file.crearUpload(
      "#evidenciasImpericiaCorrectivo",
      "Seguimiento/guardarDiagnosticoEquipo",
      null,
    ...
    console.log(evidenciaFallaEquipo);
    file.crearUpload(
      "#evidenciasFallaEquipoCorrectivo",
      "Seguimiento/guardarDiagnosticoEquipo",
      null,
    ...
    file.crearUpload(
      "#evidenciasSolucionReparacionSinEquipo",
    ...
    file.crearUpload(
      "#evidenciasSolucionReparacionConRefaccion",
    ...
    file.crearUpload(
      "#evidenciasSolucionCambioEquipo",
    ...
    file.crearUpload(
      "#archivosAgregarObservacionesReporteFalso",
  ...
  function personalizarDependiendoSucursalCorrectivo() {
    ...
    if (respuesta.informacion.informacionDatosGeneralesCorrectivo.length > 0) {
      ...
      $("#selectRefaccionSolucionReparacionConRefaccion").removeAttr(
        "disabled"
      );
      $("#inputCantidadRefaccionSolicitudReparacionConRefaccion").removeAttr(
        "disabled"
      );
        ...
        switch (respuesta.informacion.diagnosticoEquipo[0].IdTipoDiagnostico) {
          case "1":
            $("#inputObservacionesReporteFalsoCorrectivo").val(
              respuesta.informacion.diagnosticoEquipo[0].Observaciones
            );
            break;
          case "2":
            ...
            select.cambiarOpcion(
              "#selectImpericiaTipoFallaEquipoCorrectivo",
              respuesta.informacion.diagnosticoEquipo[0].IdTipoFalla
            );
            $("[href=#reporte-falso]")
              .parent("li")
              .removeClass("active");
          ...
          case "4":
            ...
            select.cambiarOpcion(
              "#selectComponenteDiagnosticoCorrectivo",
              respuesta.informacion.diagnosticoEquipo[0].IdComponente
            );
            $("[href=#reporte-falso]")
              .parent("li")
              .removeClass("active");
            $("#reporte-falso").removeClass("active in");
            $("[href=#falla-componente]")
              .parent("li")
              .addClass("active");
    ...
    if (respuesta.informacion.idTipoProblema !== null) {
      if (respuesta.informacion.idTipoProblema.length > 0) {
        switch (respuesta.informacion.idTipoProblema[0].IdTipoProblema) {
          case "1":
            recargandoTablaSolicitudRefaccion(
              respuesta.informacion.solicitudesRefaccionServicios
            );
            break;
          case "2":
            recargandoTablaSolicitudEquipo(
              respuesta.informacion.solicitudesEquiposServicios
            );
            $("[href=#solicitud-refaccion]")
              .parent("li")
              .removeClass("active");
          ...
          case "3":
            if (
              ...
              select.cambiarOpcion(
                "#selectEquipoRespaldo",
                respuesta.informacion.correctivoGarantiaRespaldo[0].IdModelo
              );
              $("#inputSerieRespaldo").val(
                respuesta.informacion.correctivoGarantiaRespaldo[0].Serie
              );
          ...
          case "Envio":
            if (respuesta.informacion.envioEquipo !== null) {
              if (respuesta.informacion.envioEquipo.length > 0) {
                ...
                select.cambiarOpcion(
                  "#selectTipoEnvioGarantia",
                  respuesta.informacion.envioEquipo[0].IdTipoEnvio
                );
                select.cambiarOpcion(
                  "#selectListaTipoEnvioGarantia",
                  respuesta.informacion.envioEquipo[0].IdPaqueteriaConsolidado
                );
                select.cambiarOpcion(
                  "#selectEquipoRespaldoEntregaEnvioGarantia",
                  respuesta.informacion.envioEquipo[0].Recibe
                );
                if (
                  respuesta.informacion.envioEquipo[0].IdUsuarioCapturaEnvio !==
                  null
                ) {
        ...
        switch (respuesta.informacion.correctivosSoluciones[0].IdTipoSolucion) {
          case "1":
            select.cambiarOpcion(
              ...
              respuesta.informacion.correctivosSinEquipo[0].IdSolucionEquipo
            );
            $("#inputObservacionesSolucionReparacionSinEquipo").val(
              respuesta.informacion.correctivosSoluciones[0].Observaciones
            );
            break;
          case "2":
            recargandoTablaReparacionRefaccion(
              respuesta.informacion.correctivosSolucionRefaccion
            );
            $("#inputObservacionesSolucionReparacionConRefaccion").val(
              respuesta.informacion.correctivosSoluciones[0].Observaciones
            );
            $("[href=#reparacion-sin-Equipo]")
              .parent("li")
              .removeClass("active");
            $("#reparacion-sin-Equipo").removeClass("active in");
            $("[href=#reparacion-con-refaccion]")
              .parent("li")
              .addClass("active");
          ...
          case "3":
            select.cambiarOpcion(
              ...
              respuesta.informacion.correctivosSolucionCambio[0].IdModelo
            );
            $("#inputSerieSolucionCambioEquipo").val(
              respuesta.informacion.correctivosSolucionCambio[0].Serie
            );
  ...
  function eventosParaSeccionSeguimientoCorrectivo() {
    ...
    var respuesta = arguments[1];
    var servicio = datosTabla[0];
    var datosGeneralesCorrectivo =
      respuesta.informacion.informacionDatosGeneralesCorrectivo;
        ...
        evento.enviarEvento(
          ...
          function(respuesta) {
            if (respuesta !== false) {
              ...
              evento.mostrarMensaje(
                ".errorDatosCorrectivo",
                false,
                "No hay equipos reguistrados para el Area y Punto.",
                5000
              );
              $("#selectAreaPuntoCorrectivo").attr("disabled", "disabled");
            }
          ...
          function(respuesta) {
            ...
            if (datosGeneralesCorrectivo.length > 0) {
              if (nuevoArrayIdModelos.length > 0) {
                if (
                  $.inArray(
                    datosGeneralesCorrectivo[0].IdModelo,
                    nuevoArrayIdModelos
                  ) !== -1
                ) {
        ...
        function(respuesta) {
          ...
          if (datosDiagnosticoEquipo !== undefined) {
            if (datosDiagnosticoEquipo.IdTipoDiagnostico === "2") {
              select.cambiarOpcion(
                "#selectImpericiaFallaDiagnosticoCorrectivo",
                datosDiagnosticoEquipo.IdFalla
              );
            }
          }
        }
    ...
    $("#selectComponenteDiagnosticoCorrectivo").on("change", function() {
      ...
      $("#selectTipoFallaComponenteCorrectivo")
        .empty()
        .append('<option value="">Seleccionar</option>');
      $("#selectFallaComponenteDiagnosticoCorrectivo").attr(
        "disabled",
        "disabled"
      );
      evento.enviarEvento(
        ...
        function(respuesta) {
          ...
          if (datosDiagnosticoEquipo !== undefined) {
            if (datosDiagnosticoEquipo.IdTipoDiagnostico === "4") {
              select.cambiarOpcion(
                "#selectTipoFallaComponenteCorrectivo",
                datosDiagnosticoEquipo.IdTipoFalla
              );
            }
          }
        }
    ...
    $("#camposExtrasCorrectivo").on("click", function(e) {
      if ($("#divCamposExtraCorrectivo").hasClass("hidden")) {
        ...
        $("#camposExtrasCorrectivo")
          .empty()
          .html("<a><strong> Mostrar sólo equipos censados</strong></a>");
        $("#selectEquipoCorrectivo").removeAttr("disabled");
        $("#selectEquipoCorrectivo")
          .empty()
          .append('<option value="">Seleccionar</option>');
        ...
        $("#camposExtrasCorrectivo")
          .empty()
          .html(
            "<a><strong> Click aquí su el equipo no está en el registro</strong></a>"
          );
      ...
      function() {
        ...
        if (datosTablaRefaccionSolicitud[0] !== undefined) {
          evento.mostrarModal(
            ...
            vistaDetallesSolicitud(datosTablaRefaccionSolicitud)
          );
          $("#btnModalConfirmar").addClass("hidden");
          $("#btnModalAbortar")
            .empty()
          ...
          $("#data-table-detalles-solicitud tbody").on(
            ...
            function() {
              var datosTablaDetallesSolicitud = $(
                ...
                .rows(this)
                .data();
              eliminarFilaTablaDetallesSolicitud(
                datosTablaDetallesSolicitud[0][0],
                "refaccion",
                servicio,
                datosTabla[1]
              );
    ...
    $("#btnAgregarSolicitudEquipo").on("click", function(e) {
      if (
        validarCampos(
          ...
          "Debes seleccionar el campo Equipo."
        )
      ) {
        if (
          validarSolitud(
        ...
        function(respuesta) {
          if (respuesta) {
            ...
            if (datosTablaEquiposSolicitudes.length > 0) {
              if (solicitud !== undefined) {
                var sucursal = $("#selectSucursalesCorrectivo").val();
                guardarDatosTablaEquiposSolicitudes(
                  datosTablaEquiposSolicitudes,
                  servicio,
                  datosTabla,
                  sucursal,
                  respuestaAnterior,
                ...
                evento.mostrarMensaje(
                  ".errorEquipoSolicitud",
                  false,
                  "Para guardar los Equipos debe seleccionar opción.",
                  5000
                );
              }
            } else {
              evento.mostrarMensaje(
                ".errorEquipoSolicitud",
                false,
                "Para guardar los Equipos debe haber agregado un registro en la tabla.",
                3000
              );
            }
          } else {
            evento.mostrarMensaje(
              ".errorEquipoSolicitud",
              false,
              "Para guardar los Equipos debe guardar los datos del diagnostico.",
              5000
            );
          }
        }
    ...
    $("#data-table-servicios-solicitudes-equipos tbody").on(
      ...
      function() {
        ...
        if (datosTablaEquiposSolicitud[0] !== undefined) {
          evento.mostrarModal(
            "Detalles de la Solicitud",
            vistaDetallesSolicitud(datosTablaEquiposSolicitud)
          );
          $("#btnModalConfirmar").addClass("hidden");
          $("#btnModalAbortar")
            .empty()
      ...
      if (
        ...
        if (
          validarCampos(
            $("#inputSerieRespaldo").val(),
            ".errorEquipoRespaldo",
            "Debes ingresar datos en el campo Serie."
          )
        ) {
          var equipoRetirado = $(
            "#selectEquipoCorrectivo option:selected"
          ).text();
          var serieRetirado = $("#selectEquipoCorrectivo option:selected").attr(
            "data-serie"
          );
          var equipoRespaldo = $(
            "#selectEquipoRespaldo option:selected"
          ).text();
          ...
          var html =
            '<div class="row">\n\
                        <div class="col-md-12 text-center">\n\
                            <div class="form-group">\n\
                                <h5> Equipo Retirado: <strong>' +
            equipoRetirado +
            "</strong>   Serie Equipo Retirado: <strong>" +
            serieRetirado +
            '</strong></h5>\n\
                            </div>\n\
                        </div>\n\
                        <div class="row">\n\
                            <div class="col-md-12 text-center">\n\
                                <div class="form-group">\n\
                                    <h5> Equipo Respaldo: <strong>' +
            equipoRespaldo +
            "</strong>   Serie Equipo Respaldo: <strong>" +
            serieRespaldo +
            "</strong></h5>\n\
                                </div>\n\
                            </div>\n\
          ...
          evento.mostrarModal(
            "Retiro a Garantía con Respaldo",
            modalCampoFirmaSolicitud(html, "Nombre del Gerente")
          );
          $("#btnModalConfirmar").addClass("hidden");
          $("#btnModalConfirmar").off("click");
          var data = {
      ...
      $("#btnGuardarAutorizacion").on("click", function(e) {
        if (
          validarCampos(
            $("#inputAutoriza").val(),
            ".errorAtorizacion",
            "Debes llenar el campo de la Persona que autoriza."
          )
        ) {
          if (
            validarCampos(
              $("#evidenciasAutorizacion").val(),
              ".errorAtorizacion",
              "Debes llenar el campo de la evidencia de la autorizacion."
            )
          ) {
    ...
    $("#btnGuardarEntregarEquipo").on("click", function(e) {
      if (
        validarCampos(
          ...
          ".errorEntregaEquipo",
          "Debes seleccionar el campo de quien se entrega."
        )
      ) {
        var equipoRetirado = $(
          "#selectEquipoCorrectivo option:selected"
    ...
    $("#btnGuardarEntregarTI").on("click", function(e) {
      if (
        ...
        evento.mostrarModal(
          "Acuse de Entrega a TI",
          modalCampoFirmaSolicitud(html, "Nombre personal TI")
        );
        $("#btnModalConfirmar").addClass("hidden");
        $("#btnModalConfirmar").off("click");
        $("#campoCorreo")
    ...
    $("#btnGuardarEnvioGarantia").on("click", function() {
      if (
        validarCampos(
          ...
          "#errorGuardarEnvioGarantia",
          "Debes seleccionar el campo como en envia."
        )
      ) {
        if (
          validarCampos(
            $("#selectListaTipoEnvioGarantia").val(),
            "#errorGuardarEnvioGarantia",
            "Debes selecionar el campo paqueteria o consolidado."
          )
        ) {
          if (
            validarCampos(
              ...
              "#errorGuardarEnvioGarantia",
              "Debes llenar el campo de guía."
            )
          ) {
            if (
              validarCampos(
                $("#evidenciaEnvioGarantia").val(),
                "#errorGuardarEnvioGarantia",
                "Debes seleccionar la evidencias de envio."
              )
            ) {
    ...
    $("#btnGuardarEnvioEntregaGarantia").on("click", function() {
      if (
        validarCampos(
          ...
          "Debes llenar el campo Fecha y Hora."
        )
      ) {
        if (
          validarCampos(
            $("#selectEquipoRespaldoEntregaEnvioGarantia").val(),
            "#errorGuardarEnvioEntregaGarantia",
            "Debes seleccionar el campo de quien recibe."
          )
        ) {
          if (
            validarCampos(
              $("#evidenciaEntregaEnvioGarantia").val(),
              "#errorGuardarEnvioEntregaGarantia",
              "Debes seleccionar la evidencias de envio."
            )
          ) {
    ...
    $("#btnAgregarReparacionConRefaccion").on("click", function(e) {
      if (
        validarCampos(
          ...
          ".errorFormularioSolucionReparacionConRefaccion",
          "Debes seleccionar el campo Refacción."
        )
      ) {
        if (
          ...
          if (
            ...
            if (
              validarSolitud(
                "#data-table-reparacion-refaccion",
                $("#selectRefaccionSolucionReparacionConRefaccion").val(),
                ".errorFormularioSolucionReparacionConRefaccion"
              )
            ) {
      ...
      evento.enviarEvento(
        ...
        function(respuesta) {
          if (respuesta) {
            evento.enviarEvento(
              ...
              function(respuesta) {
                if (respuesta === true) {
                  ...
                  servicios.mensajeModal(
                    "No existe Folio para este servicio",
                    "Advertencia",
                    true
                  );
                }
            ...
            servicios.mensajeModal(
              "No se ha guardado el Diagnostico",
              "Advertencia",
              true
            );
          }
    ...
    $("#btnGuardarReparacionSinEquipo").on("click", function(e) {
      if (
        validarCampos(
          ...
          ".errorFormularioSolucionReparacionSinEquipo",
          "Debes seleccionar el campo Solución."
        )
      ) {
        if (
          $("#evidenciasSolucionReparacionSinEquipo").val() !== "" ||
          respuesta.informacion.evidenciasCorrectivosSoluciones !== null
        ) {
          guardarConcluirCorrectivoReparacionSinEquipo(
            servicio,
            datosTabla,
            respuesta.informacion.correctivosSoluciones,
            "1"
          );
        } else if (
          $("#evidenciasSolucionReparacionSinEquipo").val() !== "" &&
              ...
              function(respuesta) {
                if (respuesta) {
                  guardarConcluirCorrectivoReparacionSinEquipo(
                    servicio,
                    datosTabla,
                    respuestaAnterior.informacion.correctivosSoluciones,
                    "2",
                    respuestaAnterior
                  );
                } else {
    ...
    $("#btnGuardarSolucionReparacionConRefaccion").on("click", function(e) {
      if ($("#data-table-reparacion-refaccion-stock").length) {
        ...
        _refacciones =
          _refacciones !== "" ? _refacciones.substring(1) : _refacciones;
        _evidencias = $("#evidenciasSolucionReparacionConRefaccion").val(); //
        if (
          _refacciones !== "" &&
          (_evidencias !== "" ||
            respuesta.informacion.evidenciasCorrectivosSoluciones.length > 0)
        ) {
          ...
          var _mensaje =
            "Para guardar la información debes seleccionar al menos una refacción y tener una evidencia";
          evento.mostrarMensaje(
            ".errorFormularioSolucionReparacionConRefaccion",
            false,
            _mensaje,
        ...
        var datosTablaReparacionRefaccion = $(
          "#data-table-reparacion-refaccion"
        )
          .DataTable()
          .rows()
      ...
      if (
        ...
        if ($("#data-table-reparacion-refaccion-stock").length) {
          ...
          if (
            ...
            var _mensaje =
              "Para concluir el servicio debes seleccionar al menos una refacción y tener una evidencia";
            evento.mostrarMensaje(
              ".errorFormularioSolucionReparacionConRefaccion",
              false,
              _mensaje,
    ...
    $("#btnGuardarSolucionCambioEquipo").on("click", function(e) {
      if ($("#data-table-reparacion-cambio-stock").length) {
        ...
        if (
          validarCampos(
            $("#selectEquipoSolucionCambioEquipo").val(),
            ".errorFormularioSolucionCambioEquipo",
            "Debes seleccionar el campo Equipo."
          )
        ) {
          if (
            validarCampos(
              $("#inputSerieSolucionCambioEquipo").val(),
              ".errorFormularioSolucionCambioEquipo",
              "Debes llenar el campo de Número de Serie."
            )
          ) {
            if (
              $("#evidenciasSolucionCambioEquipo").val() !== "" ||
              respuesta.informacion.evidenciasCorrectivosSoluciones !== null
            ) {
              guardarConcluirCorrectivoCambioEquipo(
                servicio,
    ...
    $("#btnConfirmarAgregarObservacionesReporteFalso").on("click", function() {
      ...
      if (observaciones !== "") {
          ...
          function(respuesta) {
            if (respuesta.code === 200) {
              $("#divBitacoraReporteFalso")
                .empty()
                .append(respuesta.message);
              file.limpiar("#archivosAgregarObservacionesReporteFalso");
              $("#txtAgregarObservacion").val("");
              servicios.mensajeModal(
                "Se agrego la observación.",
                "Correcto",
                true
              );
        ...
        evento.mostrarMensaje(
          "#errorAgregarObservacionesReporteFalso",
          false,
          "Debe capturar la observación.",
          3000
        );
      }
    });
  ...
  function validarFormularioDatosGeneralesCorrectivo() {
    ...
    if (sucursal !== "") {
      if (areaPunto !== "") {
        if (equipo !== "") {
          if ($("#divCamposExtraCorrectivo").hasClass("hidden")) {
            serie = $("#selectEquipoCorrectivo option:selected").attr(
              "data-serie"
            );
            numTerminal = $("#selectEquipoCorrectivo option:selected").attr(
              "data-terminal"
            );
            var data = {
              servicio: datosTabla[0],
            ...
            if (serie !== "") {
              if (numTerminal !== "") {
                ...
                evento.mostrarMensaje(
                  ".errorDatosCorrectivo",
                  false,
                  "Debes llenar el campo Número de Terminal.",
                  3000
                );
              }
            } else {
              evento.mostrarMensaje(
                ".errorDatosCorrectivo",
                false,
                "Debes selecionar el campo Serie.",
                3000
              );
            }
          }
          ...
          evento.mostrarMensaje(
            ".errorDatosCorrectivo",
            false,
            "Debes selecionar el campo Equipo.",
            3000
          );
        }
      } else {
        evento.mostrarMensaje(
          ".errorDatosCorrectivo",
          false,
          "Debes seleccionar el campo Área y Punto.",
          3000
        );
      }
    } else {
      evento.mostrarMensaje(
        ".errorDatosCorrectivo",
        false,
        "Debes seleccionar el campo Sucursal.",
        3000
      );
    }
  };
    ...
    switch (tipoDiagnostico) {
      case "1":
        data = {
          ...
          tipoDiagnosticoAnterior: tipoDiagnosticoAnterior
        };
        estatus = "concluir";
  ...
  function agregandoSolicitudRefaccion() {
    ...
    var nombreRefaccion = $(
      "#selectRefaccionSolucionReparacionConRefaccion option:selected"
    ).text();
    var cantidad = $(
      "#inputCantidadRefaccionSolicitudReparacionConRefaccion"
    ).val();
  ...
  function recargandoTablaSolicitudRefaccion(solicitudesRefaccion) {
    ...
    if (solicitudesRefaccion.length > 0) {
      ...
      $.each(solicitudesRefaccion, function(key, item) {
        ...
        tabla.agregarFila("#data-table-servicios-solicitudes-refacciones", [
          item.Servicio,
          item.Solicitante,
          item.FechaCreacion,
          refaccionCantidad,
  ...
  function recargandoTablaSolicitudEquipo(solicitudesEquipo) {
    ...
    if (solicitudesEquipo.length > 0) {
      ...
      $.each(solicitudesEquipo, function(key, item) {
        ...
        tabla.agregarFila("#data-table-servicios-solicitudes-equipos", [
          item.Servicio,
          item.Solicitante,
          item.FechaCreacion,
          equipoCantidad,
    ...
    file.enviarArchivos(
      ...
      function(respuesta) {
        ...
        if (respuesta instanceof Array || respuesta instanceof Object) {
          ...
          $("#divAutoriza")
            .empty()
            .html(respuesta[0].Autoriza);
          $("#divEvidenciasAtorizacion")
            .empty()
            .html(html);
          ...
          evento.mostrarMensaje(
            ".errorInformacionRespaldo",
            false,
            "No se guardo la evidencia contacte al equipo de desarrollo.",
            5000
          );
        }
      }
...
//    $("#btnModalConfirmar").addClass("disabled");
        ...
        if (respuesta instanceof Array || respuesta instanceof Object) {
          ...
          htmlDatosFirma =
            '<div class="col-md-offset-4 col-md-4 col-sm-offset-3 col-sm-6 col-xs-offset-12 col-xs-12">\n\
                                    ...
                                    <img style="max-height: 120px;" src="' +
            respuesta[0].Firma +
  ...
  function guardarEnvioGarantia() {
    ...
    var data = {
      servicio: servicio,
      envia: envia,
      paqueteriaConsolidado: paqueteriaConsolidado,
      guia: guia,
  ...
  function guardarConcluirCorrectivoReparacionSinEquipo() {
    ...
    var observaciones = $(
      "#inputObservacionesSolucionReparacionSinEquipo"
    ).val();
    var data = {};
    var evidencias = "";
        ...
        function(respuesta) {
          if (respuesta.message !== "faltaDatosGenerales") {
            if (respuesta.message !== "faltaDatosDiagnostico") {
              ...
              if (
                operacion === "2" &&
                respuesta.message !== "faltanServicios"
              ) {
                evento.enviarEvento(
                  "Seguimiento/enviarSolucionCorrectivoSD",
                  dataSD,
              ...
              evento.mostrarMensaje(
                ".errorFormularioSolucionReparacionSinEquipo",
                false,
                "Debe guardar los datos del dignostico.",
                5000
              );
            }
          } else {
  ...
  function guardarConcluirCorrectivoReparacionConRefaccion() {
    ...
    var observaciones = $(
      "#inputObservacionesSolucionReparacionConRefaccion"
    ).val();
    var datosTabla = [];
    var data = {};
    var evidencias = "";
    ...
    if (datosTablaDetallesSolicitud[0] !== undefined) {
      switch (datosTablaDetallesSolicitud[0][4]) {
        case "ABIERTO":
          tipoAlerta = "warning";
          textoSolicitud =
            "Su Solicitud aún no ha sido atendida por el Usuario. Porfavor póngase en contacto con el área correspondiente.";
          break;
        case "EN ATENCIÓN":
          tipoAlerta = "info";
          textoSolicitud =
            "Su Solicitud está siendo atendida por el <strong>Encargado de Refacciones</strong>.";
          break;
        case "CONCLUIDO":
          tipoAlerta = "success";
        ...
        case "EN TRÁNSITO":
          tipoAlerta = "info";
          textoSolicitud =
            "Su Solicitud está siendo antendida por el <strong>Departamento de Logística</strong>.";
          break;
        default:
      }
      ...
      var vistaSolicitud =
        '<div class="row">\n\
                                <div class="col-sm-6 col-md-6">\n\
                                    <div class="form-group">\n\
                                        <label> Solicita: <strong>' +
        datosTablaDetallesSolicitud[0][1] +
        '</strong></label>\n\
                                    </div>\n\
                                </div>\n\
                                <div class="col-sm-6 col-md-6">\n\
                                    <div class="form-group">\n\
                                        <label> Fecha de Solicitud: <strong>' +
        datosTablaDetallesSolicitud[0][2] +
        '</strong></label>\n\
                                    </div>\n\
                                </div>\n\
                            </div>\n\
        ...
        ' fade in m-t-15">\n\
                                Solicitud <strong>' +
        datosTablaDetallesSolicitud[0][4] +
        "!</strong>\n\
                                " +
        textoSolicitud +
        '\n\
  ...
  function validarSolitud() {
    ...
    if (!repetido) {
      ...
      evento.mostrarMensaje(
        divError,
        false,
        "Ya se agregó ese valor, favor de eliminar el que esta registrado si quiere actualizarlo",
        4000
      );
    }
  };
  function modalCampoFirmaSolicitud() {
    ...
    html += textoExtra;
    html +=
      '        <form class="margin-bottom-0" id="formFirmaPoliza" data-parsley-validate="true">\n\
                            <div class="row m-t-10">\n\
                                <div class="col-md-8 col-md-offset-2 col-xs-8 col-xs-offset-2">\n\
                                    <div class="form-group">\n\
                                        <label for="inputRecibeFirma">' +
      campoInput +
      ' *</label>\n\
      ...
      if (imgInput !== "") {
        if ($("#terminos").attr("checked")) {
                ...
                case "2":
                  ...
                  if (
                    validarCampos(
                      $("#selectEntregaGarantia").val(),
                      ".errorFirma",
                      "Debes seleccionar aquien se entrega."
                    )
                  ) {
          ...
          evento.mostrarMensaje(
            ".errorFirma",
            false,
            "Debes aceptar los Terminos y Declaración de Privacidad.",
            4000
          );
        }
        ...
        function(respuesta) {
          if (respuesta instanceof Array) {
            ...
            evento.mostrarMensaje(
              ".errorTablaSolicitudes",
              false,
              "Hubo un error contacte al Área correspondiente",
              3000
            );
          }
        }
  ...
  function confirmacionFirmaProblema(servicio, ticket) {
    var data = { servicio: servicio };
    evento.enviarEvento(
      "Seguimiento/verificarDiagnostico",
      data,
    ...
    $('a[data-toggle="tab"]').on("shown.bs.tab", function(e) {
      ...
      switch (target) {
        case "#DeviceTransfers":
          deviceTransferAndDeviceRequestForm(serviceId);
          break;
      }
    });
  }
