$(function() {
  ...
  var incioEtiquetas = function() {
    ...
    tabla.generaTablaPersonal(
      "#listaRefaccionUtilizadaLaboratorio",
      null,
      null,
      true,
      true,
    ...
    file.crearUpload(
      "#archivosProblemaGuia",
      "Seguimiento/GuardarProblemaGuiaLogistica"
    );
    file.crearUpload("#evidenciaEnvio", "Seguimiento/GuardarEnvioLogistica");
    file.crearUpload(
      "#evidenciaRecepcionAlmacen",
      "Seguimiento/GuardarRecepcionAlmacen"
    );
    file.crearUpload(
      "#evidenciaRecepcionLab",
      "Seguimiento/GuardarRecepcionLaboratorio"
    );
    file.crearUpload(
      "#archivosLabHistorial",
      "Seguimiento/AgregarComentarioSeguimientosEquipos"
    );
    file.crearUpload(
      "#evidenciaRecepcionLogistica",
      "Seguimiento/GuardarRecepcionLogistica"
    );
    file.crearUpload(
      "#evidenciaEntrega",
    ...
    file.crearUpload(
      ...
      "Seguimiento/GuardarRecepcionTecnico"
    );
    file.crearUpload(
      "#evidenciaRecepcionlog",
      "Seguimiento/subirAdjuntosLabHistorial"
    );

    file.crearUpload(
      "#adjuntosProblemaAlm",
      "Seguimiento/AgregarRecepcionesProblemasSeguimientosEquipos"
    );
    file.crearUpload(
      "#adjuntosProblemaLab",
      "Seguimiento/AgregarRecepcionesProblemasSeguimientosEquipos"
  ...
  $("#lista-equipos-enviados-solicitados tbody").on("click", "tr", function() {
    ...
    var datos = $("#lista-equipos-enviados-solicitados")
      .DataTable()
      .row(this)
      .data();
    if (datos !== undefined) {
  ...
  var formulario = function() {
    ...
    evento.enviarEvento("Seguimiento/VistaPorPerfil", datos, panel, function(
      respuesta
    ) {
  ...
  function iniciasolicitudCotizacion() {
    select.crearSelect("#serviceDeskValidators");
  }

  var vistasDeFormularios = function(respuesta) {
    $("#panelTablaEquiposEnviados").addClass("hidden");
    $("#seccionFormulariosRecepcionTecnico")
      .removeClass("hidden")
      .empty()
      .append(respuesta.formularioRecepcionTecnico.formularioRecepcionTecnico);
    $("#seccionFormulariosEnvSegLog")
      .removeClass("hidden")
      .empty()
      .append(
        respuesta.formularioEnvioSeguimientoLog.formularioEnvioSeguimientoLog
      );
    $("#seccionFormulariosRecepcionLogistica")
      .removeClass("hidden")
      .empty()
      .append(respuesta.formularioRecepcionLog.formularioRecepcionLogistica);
    $("#seccionFormulariosRevisionHistorial")
      .removeClass("hidden")
      .empty()
      .append(
        respuesta.formularioHistorialRefaccion.formularioRevisionHistorial
      );
    $("#seccionFormulariosRecepcionLaboratorio")
      .removeClass("hidden")
      .empty()
      .append(respuesta.formularioRecepcionLab.formularioRecepcionLaboratorio);
    $("#seccionFormulariosRecepcionAlmacen")
      .removeClass("hidden")
      .empty()
      .append(respuesta.formularioRecepcionAlmacen.formularioRecepcionAlmacen);
    $("#seccionFormulariosRecepcionAlmacenRegreso")
      .removeClass("hidden")
      .empty()
      .append(
        respuesta.formularioRecepcionAlmacenRegreso
          .formularioRecepcionAlmacenRegreso
      );
    $("#seccionPanelEspera")
      .removeClass("hidden")
      .empty()
      .append(respuesta.PanelEspera.panelEspera);
    $("#seccionFormulariosGuia")
      .removeClass("hidden")
      .empty()
      .append(respuesta.formularioEnvioAlmacen.formularioGuia);
    $("#seccionFormulariosSinGuia")
      .removeClass("hidden")
      .empty()
      .append(respuesta.formularioGuia.formularioParaGuia);
    $("#seccionFormulariosValidacion")
      .removeClass("hidden")
      .empty()
      .append(respuesta.formularioValidacion.formularioValidacion);

    if (
      $.inArray("306", respuesta.permisos) !== -1 ||
      $.inArray("306", respuesta.permisosAdicionales) !== -1 ||
      $.inArray("307", respuesta.permisos) !== -1 ||
      $.inArray("307", respuesta.permisosAdicionales) !== -1
    ) {
      //            bloquerTodosCampos();
    }
    ...
    if (respuesta.formularioEnvioSeguimientoLog !== undefined) {
      if (respuesta.formularioEnvioSeguimientoLog.datos !== undefined) {
        if (
          respuesta.formularioEnvioSeguimientoLog.datos.informacionEnvioLog !==
          null
        ) {
          var $radiosTipoEnvio = $('input[name="radioTipoEnvio"]');
          if (
            respuesta.formularioEnvioSeguimientoLog.datos.informacionEnvioLog[0]
              .IdUsuarioTransito !== null
          ) {
          ...
          $radiosCuenta
            .filter(
              "[value=" +
                respuesta.formularioEnvioSeguimientoLog.datos
                  .informacionEnvioLog[0].CuentaSiccob +
                "]"
            )
            .attr("checked", true);
  ...
  var eventosGenerales = function() {
    ...
    $("#listaTicket").on("change", function() {
      ...
      if ($(this).val() !== "") {
        ...
        evento.enviarEvento(
          "Seguimiento/ConsultaServiciosTecnico",
          datos,
          "#panelValidacion",
          function(respuesta) {
            $("#listaServicio")
              .empty()
              .append(
                '<option value="" data-idModelo = "" data-serie="">Seleccionar</option>'
              )
              .attr("disabled", "disabled");

            $.each(respuesta, function(k, v) {
              $("#listaServicio").append(
                '<option value="' +
                  v.Id +
                  '" data-idModelo = "' +
                  v.IdModelo +
    ...
    $("#listaServicio").on("change", function() {
      var servicioSeleccionado = $("#listaServicio option:selected").attr(
        "data-idModelo"
      );
      ...
      if (servicioSeleccionado !== "") {
        ...
        evento.enviarEvento(
          "Seguimiento/MostrarEquipoDanado",
          datos,
          "#panelValidacion",
          function(respuesta) {
            if (respuesta.length > 0) {
              $.each(respuesta, function(k, v) {
                $("#equipoEnviado")
                  .empty()
                  .attr({ value: v.Equipo, "data-IdEquipo": v.Id });
              });
    ...
    $("#listaTipoPersonal").on("change", function() {
      ...
      evento.enviarEvento(
        "Seguimiento/MostrarNombrePersonalValida",
        datos,
        "#panelValidacion",
        function(respuesta) {
          if (respuesta) {
            $.each(respuesta, function(k, v) {
              $("#listaNombrePersonal").append(
      ...
      var disabledRadio = $("input[type=radio][name=movimiento]").attr(
        "disabled"
      );
    ...
    $("#listaSolicitarEquipo").on("change", function() {
      ...
      $("#listaSolicitarRefaccion")
        .empty()
        .append('<option value="">Seleccionar</option>');
      select.cambiarOpcion("#listaSolicitarRefaccion", "");

      evento.enviarEvento(
        "Seguimiento/MostrarRefaccionXEquipo",
        datos,
        panel,
        function(respuesta) {
          if (respuesta.length > 0) {
            $.each(respuesta, function(k, v) {
              $("#listaSolicitarRefaccion").append(
                '<option value="' + v.Id + '">' + v.Nombre + "</option>"
              );
            });
    ...
    $("#btnGuardarValidacion").on("click", function() {
      var arrayCampos = [
        {
          objeto: "#listaTicket",
          mensajeError: "Falta seleccionar el ticket."
        },
        {
          objeto: "#listaServicio",
          mensajeError: "Falta seleccionar el servicio."
        },
        {
          objeto: "#listaTipoPersonal",
          mensajeError: "Falta seleccionar el tipo de personal que valida."
        },
        {
          objeto: "#listaNombrePersonal",
          mensajeError: "Falta seleccionar el personal que valida."
        }
      ];

      var camposFormularioValidados = evento.validarCamposObjetos(
        arrayCampos,
        "#errorFormularioValidacion"
      );
      ...
      if (camposFormularioValidados) {
        ...
        var IdModelo = $("#listaServicio")
          .find(":selected")
          .attr("data-idmodelo");
        var Serie = $("#listaServicio")
          .find(":selected")
          .attr("data-serie");
        ...
        if (tipoMovimiento !== "") {
          switch (tipoMovimiento) {
            ...
            case "3":
              ...
              if (idEquipoEnviado !== "") {
                ...
                datosValidacion.IdRefaccion =
                  idEquipoEnviado.selectEquipoRefaccion || null;
          ...
          evento.mostrarMensaje(
            "#errorFormularioValidacion",
            false,
            "Selecciona el movimiento que va a realizar.",
            4000
          );
        }
      }
    ...
    $("#btnGuardarEnvio").on("click", function() {
      ...
      if (evento.validarFormulario("#formEnvioAlmacen")) {
        if (evidencia !== "" || evidencia !== undefined) {
          file.enviarArchivos(
            "#evidenciaEnvioGuia",
            "Seguimiento/GuardarEnvioAlmacen",
            "#panelEnvioConGuia",
            datos,
            function(respuesta) {
    ...
    $("#btnGuardarRecepcionTec").on("click", function() {
      var arrayCampos = [
        {
          objeto: "#fechaRecepcionTecnico",
          mensajeError: "Falta seleccionar la Fecha de Recepción."
        },
        {
          objeto: "#evidenciaRecepcionTecnico",
          mensajeError: "Falta seleccionar la evidencia de recepción."
        }
      ];

      var camposFormularioValidados = evento.validarCamposObjetos(
        arrayCampos,
        "#errorFormularioTecnico"
      );
          ...
          function(respuesta) {
            if (respuesta.code == 200) {
              ...
              evento.mostrarMensaje(
                "#errorFormularioTecnico",
                false,
                "Ocurrió un error al guardar el comentario. Por favor recargue su página y vuelva a intentarlo.",
                4000
              );
            }
          }
    ...
    $("#btnGuardarRecepcionLog").on("click", function() {
      var arrayCampos = [
        {
          objeto: "#fechaRecepcionLogistica",
          mensajeError: "Falta seleccionar la Fecha de Recepción."
        },
        {
          objeto: "#evidenciaRecepcionLogistica",
          mensajeError: "Falta seleccionar la evidencia de recepción."
        }
      ];
        ...
        file.enviarArchivos(
          ...
          function(respuesta) {
            if (respuesta.code == 200) {
              ...
              recargandoTablaEquiposEnviadosSolicitados(
                respuesta.tablaEquiposEnviadosSolicitados.datosTabla
              );
            }
          }
        );
    ...
    $("#btnGuardarRecepcionAlm").on("click", function() {
      var arrayCampos = [
        {
          objeto: "#fechaRecepcionAlm",
          mensajeError: "Falta seleccionar la Fecha de Recepción."
        },
        {
          objeto: "#evidenciaRecepcionAlmacen",
          mensajeError: "Falta seleccionar la evidencia de recepción."
        }
      ];
    ...
    $("#btnAgregarRefaccion").on("click", function() {
      var arrayCampos = [
        {
          objeto: "#listRefaccionUtil",
          mensajeError: "Falta seleccionar la Refacción utilizada."
        }
      ];

      var camposFormularioValidados = evento.validarCamposObjetos(
        arrayCampos,
        "#errorAgregarRefaccion"
      );
      ...
      if (camposFormularioValidados) {
        ...
        evento.enviarEvento(
          "Seguimiento/GuardarRefacionUtilizada",
          data,
    ...
    $("#consluirRevisionLab").on("click", function() {
      ...
      evento.enviarEvento(
        "Seguimiento/ConcluirRevicionLaboratorio",
        data,
        "#panelLaboratorioHistorial",
        function(respuesta) {
          if (respuesta.code === 200) {
            ...
            eventosGenerales(idTabla, respuesta.idServicio);
            eventosComentarios(idTabla, respuesta.idServicio);
            cargaComentariosAdjuntos(
              idTabla,
              respuesta.datos.formularioHistorialRefaccion
            );
            recargandoTablaEquiposEnviadosSolicitados(
              respuesta.tablaEquiposEnviadosSolicitados.datosTabla
            );
    ...
    $("#btnGuardarEnvioLogistica").on("click", function() {
      ...
      if (tipoEnvio === "1") {
        ...
        if (paqueteria === "2") {
          ...
          var arrayCampos = [
            {
              objeto: "input[name=radioTipoEnvio]:checked",
              mensajeError: "Falta seleccionar tipo de envió"
            },
            {
              objeto: "#listPaqueteria",
              mensajeError: "Falta seleccionar la paqueteria utilizada."
            },
            {
              objeto: "#fechaEnvio",
              mensajeError: "Falta seleccionar la fecha."
            },
            { objeto: "#guiaLogistica", mensajeError: "Falta la guía." },
            {
              objeto: "input[name=radioCuenta]:checked",
              mensajeError: "Falta seleccionar el tipo de cuenta"
            }
          ];
          var datos = {
            id: idTabla,
        ...
        var arrayCampos = [
          ...
          {
            objeto: "#listChofer",
            mensajeError: "Falta seleccionar el chofer."
          },
      ...
      if (camposFormularioValidados) {
        ...
        if (evidencia !== "" || evidencia !== undefined) {
          file.enviarArchivos(
            "#evidenciaEnvio",
            "Seguimiento/GuardarEnvioLogistica",
            "#panelEnvioSeguimientoLog",
            datos,
            function(respuesta) {
              if (respuesta.code === 200) {
    ...
    $("#btnGuardarEntrega").on("click", function() {
      if ($("#listDondeRecibe").val() === "2") {
        var arrayCampos = [
          {
            objeto: "#listDondeRecibe",
            mensajeError: "Falta seleccionar donde recibe."
          },
          {
            objeto: "#listSucursal",
            mensajeError: "Falta seleccionar la sucursal."
          },
          { objeto: "#fechaEnvioSegLog", mensajeError: "Falta la fecha." },
          {
            objeto: "#personaRecibe",
            mensajeError: "Falta la persona que recibe."
          },
          {
            objeto: "#evidenciaEntregaLog",
            mensajeError: "Falta seleccionar la evidencia de entrega."
          }
        ];
        var datos = {
          id: idTabla,
        ...
        var arrayCampos = [
          ...
          {
            objeto: "#personaRecibe",
            mensajeError: "Falta la parsona que recibe."
          },
          {
            objeto: "#evidenciaEntregaLog",
            mensajeError: "Falta seleccionar la evidencia de entrega.."
    ...
    $("#solicitarGuia").on("click", function() {
      ...
      evento.enviarEvento(
        "Seguimiento/MostrarFormularioInformacionGeneracionGuia",
        dataToShowTheForm,
        "#panelEnvioConGuia",
        function(respuesta) {
    ...
    $("#btnGuardarProblema").on("click", function() {
      var arrayCampos = [
        {
          objeto: "#txtComentariosGuia",
          mensajeError: "Falta escribir comentarios."
        },
        {
          objeto: "#archivosProblemaGuia",
          mensajeError: "Falta seleccionar la evidencia."
        }
      ];

      var camposFormularioValidados = evento.validarCamposObjetos(
        arrayCampos,
        "#errorGuardarGuiaLogistica"
      );
    ...
    $("#listaRefaccionUtilizada tbody").on("click", "tr", function() {
      var datos = $("#listaRefaccionUtilizada")
        .DataTable()
        .row(this)
        .data();
      if (datos !== undefined) {
        ...
        evento.enviarEvento(
          "Seguimiento/EliminarRefacionUtilizada",
          data,
          "#panelLaboratorioHistorial",
          function(respuesta) {
            if (respuesta.code === 200) {
  ...
  var mandarCotizacion = function() {
    ...
    evento.enviarEvento(
      "Seguimiento/crearDatosCotizarOpcionRevision",
      data,
      panel,
      function(respuesta) {
        evento.iniciarModal(
          "#modalSolicitarCotizacion",
        ...
        $("#btnAceptarSolicitarCotizacion").on("click", function() {
          ...
          var informacionCotizacion = $("#data-table-solicitar-componentes")
            .DataTable()
            .rows()
            .data();
          for (var index = 0; index < informacionCotizacion.length; index++) {
            datosCotizarComp.push({
              componente: informacionCotizacion[index][0],
              cantidad: document.getElementById("inputCantidad" + index).value
            });
          }
          if (radioValue == 1) {
            data["componentes"] = "";
          ...
          evento.enviarEvento(
            "Seguimiento/enviarDatosCotizarOpcionRevision",
            datosCotizar,
            panel,
            function(respuesta) {
              if (respuesta) {
  ...
  var terminarSeleccion = function() {
    ...
    evento.enviarEvento(
      "Seguimiento/GuardarSolicitudProducto",
      data,
      "#panelValidacionExistencia",
      function(respuesta) {
        if (respuesta.code === 200) {
          vistasDeFormularios(respuesta.datos);
          incioEtiquetas();
  ...
  var botonValidacionSupervisor = function() {
    ...
    evento.enviarEvento(
      "Seguimiento/ValidarSolicitudEquipo",
      data,
      "#panelValidacionSolicitudRefaccion",
      function(respuesta) {
        if (respuesta.code === 200) {
          vistasDeFormularios(respuesta.datos);
          incioEtiquetas();
  ...
  var botonGuardarValidacion = function() {
    ...
    evento.enviarEvento(
      "Seguimiento/GuardarValidacionTecnico",
      datos,
      panel,
      function(respuesta) {
  ...
  var botonSolicitarLaboratorio = function() {
    ...
    evento.enviarEvento(
      "Seguimiento/SolicitarRefaccionLaboratorio",
      data,
      "#panelValidacionExistencia",
      function(respuesta) {
        if (respuesta.code === 200) {
  ...
  var botonTerminarSeleccionLaboratorio = function() {
    ...
    evento.enviarEvento(
      "Seguimiento/AsignarRefaccionAlmacen",
      data,
      "#panelValidacionExistencia",
      function(respuesta) {
        if (respuesta.code === 200) {
  ...
  var validarEquipo = function() {
    ...
    var selectEquipoRefaccion = $(
      "#listaSolicitarRefaccion option:selected"
    ).val();

    if (seleccionEquipo !== "") {
      var equipoRefaccion = {
        seleccionEquipo: seleccionEquipo,
        selectEquipoRefaccion: selectEquipoRefaccion
      };
      ...
      evento.mostrarMensaje(
        "#errorFormularioValidacion",
        false,
        "Selecciona el equipo solicitado",
        4000
      );
    }
  };
  ...
  var eventosComentarios = function() {
    ...
    $('a[data-toggle="tab"]').on("shown.bs.tab", function(e) {
      ...
      switch (target) {
        case "#problemasRecepcionAlm":
          cargaRecepcionesProblemas(
            idTabla,
            "1",
            "28",
            "#panelRecepcionAlmacen",
            "#divNotasAdjuntosAlmacen"
          );
          break;
    ...
    $("#solicitarCotizacionButton").on("click", function() {
      ...
      var comentarios = $.trim($("#solicitudCotizacionTexto").val());
      var adjunto = $("#archivosSolicitudCotizacion").val();

      if (reasignar == "") {
        evento.mostrarMensaje(
          "#errorSolicitarCotizacion",
          false,
          "Debe seleccionar el usuario al que se va a asignar el incidente en SD",
          4000
        );
        return false;
      }
      ...
      if (comentarios == "") {
        evento.mostrarMensaje(
          "#errorSolicitarCotizacion",
          false,
          "El texto de solicitud de cotización es obligatorio.",
          4000
        );
        return false;
      }
    ...
    $("#agregarComentarioHistorial").on("click", function() {
      ...
      if (comentarios !== "" || adjunto !== "") {
        ...
        evento.mostrarMensaje(
          "#errorAgregarComentario",
          false,
          "Al menos debe agregar el comentario o un adjunto para poder agregar la información",
          4000
        );
      }
    });
      ...
      if (comentarios !== "" || adjunto !== "") {
        ...
        file.enviarArchivos(
          ...
          function(respuesta) {
            if (respuesta.code == 200) {
              evento.mostrarMensaje(
                "#errorAgregarProblemaAlm",
                true,
                "Se ha guardado la nota correctamente",
                6000
              );
              $("#txtNotaAlmacen")
                .val("")
              ...
              evento.mostrarMensaje(
                "#errorAgregarProblemaAlm",
                false,
                "Ocurrió un error al guardar la nota. Por favor recargue su página y vuelva a intentarlo.",
                4000
              );
            }
          }
        ...
        evento.mostrarMensaje(
          "#errorAgregarProblemaAlm",
          false,
          "Al menos debe agregar la nota o un adjunto para poder agregar la información",
          4000
        );
      }
    });
  ...
  var cargaComentariosAdjuntos = function() {
    ...
    if (formularioHistorialRefaccion.length !== 0) {
      evento.enviarEvento(
        "Seguimiento/CargaComentariosAdjuntos",
        datos,
        "#panelLaboratorioHistorial",
        function(respuesta) {
          if (respuesta.code == 200) {
            $("#divComentariosAdjuntos")
              .empty()
  ...
  var cargaRecepcionesProblemas = function() {
    ...
    evento.enviarEvento(
      "Seguimiento/CargaRecepcionesProblemas",
      datos,
      panel,
      function(respuesta) {
        if (respuesta.code == 200) {
  ...
  var recargandoTablaRefaccionesUtilizadas = function(refaccionesUtilizadas) {
    ...
    $.each(refaccionesUtilizadas, function(key, item) {
      tabla.agregarFila("#listaRefaccionUtilizada", [
        item.Id,
        item.Nombre,
        item.Cantidad,
        item.IdInventario
  ...
  var recargandoTablaEquiposEnviadosSolicitados = function(
    equipoEnviadosSolicitados
  ) {
    tabla.limpiarTabla("#lista-equipos-enviados-solicitados");

    $.each(equipoEnviadosSolicitados, function(key, item) {
      tabla.agregarFila("#lista-equipos-enviados-solicitados", [
        item.Id,
        item.IdServicio,
        item.Ticket,
        item.NombreSucursal,
    ...
    if (cantidad !== campos) {
      if (cantidad < campos) {
        ...
        for (var i = 0; i < cantidad; i++) {
          if (
            !$("#formInformationBoxes")
              .children("div.classForm")
              .eq(i).length
          ) {
  ...
  var htmlViewFormBoxes = function(contador) {
    var html =
      ...
      (contador + 1) +
      `" disabled="disabled" class="form-control f-s-16 text-center" />
                                </div>
                            </div>
                        </div>
                        <div class="row m-t-5">
                            <div class="col-md-3 col-sm-3 col-xs-3">
                                ...
                                <div class="input-group">
                                    <input type="number" class="form-control" id="info-peso-` +
      (contador + 1) +
      `" data-parsley-required="true"/>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-3">
                                ...
                                <div class="input-group">
                                    <input type="number" class="form-control" id="info-largo-` +
      (contador + 1) +
      `" data-parsley-required="true"/>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-3">
                                ...
                                <div class="input-group">
                                    <input type="number" class="form-control" id="info-ancho-` +
      (contador + 1) +
      `" data-parsley-required="true"/>
                                    <span class="input-group-addon">cm</span>
                                </div>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-3">
                                ...
                                <div class="input-group">
                                    <input type="number" class="form-control" id="info-alto-` +
      (contador + 1) +
      `" data-parsley-required="true"/>
                                    <span class="input-group-addon">cm</span>
                                </div>
  ...
  var creatingInformationGenerateGuide = function() {
    var dataToValidateForm = [
      ...
      {
        objeto: "#lista-TI",
        mensajeError: "Falta seleccionar personal de TI que autoriza."
      },
      { objeto: "#inputNumeroCajas", mensajeError: "Falta el no. de cajas." }
    ];

    var validatedFormsFields = evento.validarCamposObjetos(
      dataToValidateForm,
      "#errorFormularioInformacionGeneracionGuia"
    );
    if (validatedFormsFields) {
      if ($("#inputNumeroCajas").val() > 0) {
        if (evento.validarFormulario("#formInformationBoxes")) {
          ...
          textoInformacionGuia +=
            "Persona que solicita: " + nombreTecnico + "\n";
          textoInformacionGuia += "Origen: " + origen + "\n";
          textoInformacionGuia += "Destino: " + destino + "\n";
          textoInformacionGuia +=
            "Personal de TI que autoriza: " + personalAutoriza + "\n";
        ...
        evento.mostrarMensaje(
          "#errorFormularioInformacionGeneracionGuia",
          false,
          "El campo de no. cajas deber ser positivo",
          4000
        );
      }
    }
