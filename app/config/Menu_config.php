...
$config['Generales'] = array(
    ...
    'Dashboard_Gapsi' => array(
        ...
        'js' => array('Base/Base', 'Base/Socket','Componentes/Selects/Select', 'Componentes/Selects/SelectBasico', 'Generales/dashboard_gapsi', 'Componentes/Tablas/Tabla','Componentes/Tablas/TablaBasica','Componentes/Graficas/GraficaGoogle'),
        'pluginsJs' => array(
            'DataTables/js/jquery.dataTables',
            'DataTables/js/dataTables.responsive',
            'select2/dist/js/select2.min',
