<!--
 * Description: Vista de seguimiento de Facturacion y Cobranza
 *
 * @author: Alberto Barcenas
 *
-->
<!-- Empezando #contenido -->
<div id="listaFacturacionCobranza" class="content">

    <!-- Empezando titulo de la pagina -->
    <h1 class="page-header">Seguimiento Facturación y Cobranza</h1>
    <!-- Finalizando titulo de la pagina -->

    <!-- Empezando panel seguimiento Facturacion y Cobranza-->
    <div id="panelSeguimientoFacturacionCobranza" class="panel panel-inverse">
        ...
        <div class="panel-heading">
            ...
            <h4 class="panel-title">Seguimiento Facturación y Cobranza</h4>
        </div>
        ...
        <div class="panel-body">
            ...
            <div class="table-responsive">
                <table id="data-table-facturacion-cobranza" class="table table-hover table-striped table-bordered no-wrap" style="cursor:pointer" width="100%">
                    <thead>
                        <tr>
