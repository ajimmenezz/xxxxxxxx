                    ...
                    <div class="table-responsive">
                        <table class="table table-profile">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="field">Teléfono Movil</td>
                                    <td>
                                        <div class="col-xs-12">
                                            <i class="fa fa-mobile fa-lg m-r-5"></i><?php echo $datosUsuario['Tel1']; ?> 
                                            <a class="editarPerfil" data-nombreInput="Teléfono Movil" data-campo="Tel1"  data-input="<?php echo $datosUsuario['Tel1']; ?>" data-tabla="personal" href="javascript:;" class="m-l-5"> Editar</a>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div class="col-xs-12">
                                            ...
                                            <a class="editarPerfil" data-nombreInput="Teléfono Fijo" data-campo="Tel2"  data-input="<?php echo $datosUsuario['Tel2']; ?>" data-tabla="personal"href="javascript:;" class="m-l-5"> Editar</a>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div class="col-xs-12">
                                            ...
                                            <a class="editarPerfil" data-nombreInput="Email Personal" data-campo="Email"  data-input="<?php echo $datosUsuario['Email']; ?>" data-tabla="usuario" href="javascript:;" class="m-l-5" > Editar</a>
                                        </div>
                                    </td>
                                </tr>
                                <tr class="divider">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="col-xs-12">
                                            ...
                                            <a class="editarPerfil" data-nombreInput="Domicilio" data-campo="Domicilio"  data-input="<?php echo $datosUsuario['Domicilio']; ?>"  data-tabla="personal" href="javascript:;" class="m-l-5"> Editar</a>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="col-xs-12">
                                            ...
                                            <a class="editarPerfil" data-nombreInput="Codigo Postal" data-campo="CP"  data-input="<?php echo $datosUsuario['CP']; ?>" data-tabla="personal" href="javascript:;" class="m-l-5"> Editar</a>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="col-xs-12">
                                            ...
                                            <a class="editarPerfil" data-nombreInput="Genero" data-campo="IdSexo"  data-input="<?php echo $datosUsuario['Genero']; ?>" data-tabla="personal" href="javascript:;" class="m-l-5"> Editar</a>
                                        </div>
                                    </td>
                                </tr>
                            </tbody>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" value="Send Request" id="btnGuardarCambios" class="btn btn-primary">Guardar</button>
            </div>
        </div>
    </div>
</div>