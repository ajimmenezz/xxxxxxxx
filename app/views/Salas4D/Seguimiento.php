<!-- Empezando #contenido -->
<div id="listaSalasX4D" class="content">
    <!-- Empezando titulo de la pagina -->
    <h1 class="page-header">Seguimiento SalasX4D</h1>
    <!-- Finalizando titulo de la pagina -->
    <!-- Empezando panel seguimiento SalasX4D-->
    <div id="panelSeguimientoSalasX4D" class="panel panel-inverse">
        ...
        <div class="panel-heading">
            ...
            <h4 class="panel-title">Seguimiento SalasX4D</h4>
        </div>
        ...
        <div class="panel-body">
            ...
            <div class="table-responsive">
                ...
                <table id="data-table-salasX4D" class="table table-hover table-striped table-bordered no-wrap" style="cursor:pointer" width="100%">
                    <thead>
                        <tr>
    ...
    <!-- Finalizando panel seguimiento SalasX4D -->   
</div>
...
<!--Empezando seccion para el seguimiento de un servicio sin clasificar->-->
<div id="seccionActividadesAsignadas" class="content hidden"></div>
<!-- Finalizando seccion para el seguimiento de un servicio sin clasificar 