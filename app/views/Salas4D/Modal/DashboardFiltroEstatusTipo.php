<div class="row">
    <div class="col-md-9 col-sm-6 col-xs-12">
        <h1 class="page-header">Servicios Filtrados por Estatus de Solicitud y Tipo de Servicio.</h1>
    </div>
...
<div id="thirdPanel" class="panel panel-inverse">        
    <div class="panel-heading">
        <h4 class="panel-title">Servicios filtrados por Estatus "<?php echo $estatus; ?>" y Tipo de Servicio "<?php echo $tipo; ?>" </h4>        
    </div>
