<div class="row">
    <div class="col-md-9 col-sm-6 col-xs-12">
        <h1 class="page-header">Solicitudes filtradas por Prioridad y Estatus</h1>
    </div>
...
<div id="thirdPanel" class="panel panel-inverse">        
    <div class="panel-heading">
        <h5 class="panel-title">Solicitudes filtradas por prioridad "<?php echo $prioridad; ?>" y estatus "<?php echo $estatus; ?>"</h5>        
    </div>
    <div class="panel-body">
            ...
            <div class="row">
                <div class="col-md-12">                        
                    <div class="form-group">
                        <h4 class="m-t-10">Servicios de Solicitudes con Prioridad <?php echo $prioridad; ?> y Estatus <?php echo $estatus; ?></h4>
        ...
        <div class="row m-t-10">
            <div class="col-md-12">                        
                <div class="form-group">
                    <h4 class="m-t-10">Lista de Solicitudes con Prioridad <?php echo $prioridad; ?> y Estatus <?php echo $estatus; ?></h4>
                    <div class="underline m-b-15 m-t-15"></div>
                </div>    
            </div> 
        </div> 
