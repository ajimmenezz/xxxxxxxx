<div class="row">
    <div class="col-md-9 col-sm-6 col-xs-12">
        <h1 class="page-header">Solicitudes filtradas por Estatus</h1>
    </div>
...
<div id="secondaryPanel" class="panel panel-inverse">        
    <div class="panel-heading">
        <h4 class="panel-title">Solicitudes filtradas por estatus "<?php echo $estatus; ?>"</h4>        
    </div>
    <div class="panel-body">
        <div class="row">
            <div class="col-md-12">                        
                <div class="form-group">
                    <h3 class="m-t-10">Solicitudes con Estatus <?php echo $estatus; ?></h3>
        ...
        <div class="row m-t-10">
            <div class="col-md-6 col-sm-6 col-xs-12">
                <div id="div_chart_prioridades_filtered" style="display: none;">
                    <a class="pull-right f-s-14 f-w-600" href="#" id="btnShowPrioridadesTable">Ver Tabla(Grid)</a>
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div id="prioridades_chart_filtered" style="width: 100%; height: 400px;  max-height:400px"></div>
                    </div>
                </div>
                <div class="table-responsive" id="div_table_prioridades_filtered">
                    <a class="pull-right f-s-14 f-w-600" href="#" id="btnShowPrioridadesChart">Ver Gráfica</a>
                    <h4 class="m-t-10 f-w-600">Prioridades de Solicitudes</h4>                                                    
                    <table id="prioridad_table_filtered" class="table table-hover table-striped table-bordered no-wrap">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            <?php
                            $total = 0;
                            if (isset($generalesPrioridad)) {
                                foreach ($generalesPrioridad as $key => $value) {
                                    $total += $value['Total'];
                                    echo ''
                                    . '<tr>'
                                    . '<td>' . $value['Id'] . '</td>'
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <th class="f-w-700 text-center" id="total-cell-prioridad-filtered"><?php echo $total; ?></th>
                            </tr>
                        </tfoot>
                    </table>
                </div>
        ...
        <div class="row m-t-25">
            <div class="col-md-12">                        
                <div class="form-group">
                    <h3 class="m-t-10">Lista de Solicitudes con Estatus <?php echo $estatus; ?></h3>
                    <div class="underline m-b-15 m-t-15"></div>
                </div>    
            </div> 
        </div> 
