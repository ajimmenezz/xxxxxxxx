<div class="row">
    <div class="col-md-9 col-sm-6 col-xs-12">
        <h1 class="page-header">Servicios Filtrados por Prioridad de Solicitud y Tipo de Servicio.</h1>
    </div>
...
<div id="thirdPanel" class="panel panel-inverse">        
    <div class="panel-heading">
        <h4 class="panel-title">Servicios filtrados por Prioridad "<?php echo $prioridad; ?>" y Tipo de Servicio "<?php echo $tipo; ?>" </h4>        
    </div>
    <div class="panel-body">
        <div class="row">
            <div class="col-md-12">                        
                <div class="form-group">
                    <h3 class="m-t-10">Estatus de <?php echo $tipo; ?></h3>
        ...
        <div class="row">
            <div class="col-md-6 col-sm-6 col-xs-12">
                <div id="chart-estatus-servicios-third" style="width: 100%; height: 400px;  max-height:400px"></div>
            </div>
            <div class="col-md-6 col-sm-6 col-xs-12">                    
                <div class="table-responsive">                        
                    <h4 class="m-t-10 f-w-600">Estatus de Servicios</h4>                                                    
                    <table id="table-estatus-servicios-third" class="table table-hover table-striped table-bordered no-wrap">
                        <thead>
                            <tr>
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <th class="f-w-700 text-center" id="total-cell-estatus-servicios-third"><?php echo $total; ?></th>
                            </tr>
                        </tfoot>
                    </table>
                </div>
        ...
        <div class="row m-t-15">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="table-responsive">                    
                    <table id="table-servicios-third" class="table table-hover table-striped table-bordered no-wrap">
                        <thead>
                            <tr>
