...
<html lang="en">
    ...
    <head>
        ...
        <!--        <link href="assets/css/customize/recoverPassword.css" rel="stylesheet"/>-->
        ...
        <script src="assets/js/customize/Acceso/recuperarAcceso.js"></script>
            ...
            <div class="login login-with-news-feed">
                ...
                <div class="right-content">
                    ...
                    <div class="login-content">
                        ...
                        <form class="margin-bottom-0" id="formRecuperar" data-parsley-validate="true">
                            <label class="control-label f-s-18 f-w-400">Restablecer Usuario y Password</label>
                            <div class="checkbox m-b-15"></div>
                            <label class="control-label">
                                Para restablecer tu usuario y password. Por favor ingrese el email donde se enviara la informacion.
                            </label>
                            <div class="checkbox m-b-15"></div>
                            <div class="row m-b-15">
                                <div class="col-md-12">
                                    <input type="email" class="form-control" placeholder="Direccion de Email" name="correo" data-parsley-type="email" data-parsley-required="true"/>
                                </div>
                            </div>
                            ...
                            <div class="login-buttons">
                                <button type="button" class="btn btn-success" id="btnRecuperar" >Recuperar</button>
                                <button type="button" class="btn btn-success" id="btnRegresar" >Regresar</button>
                            </div>
                            <hr />
