...
<form class="margin-bottom-0" id="formNuevoAlmacen" data-parsley-validate="true" >
    ...
    <div class="col-md-5 m-t-10">
        <div class="form-group">
            <label>Nombre *</label>
            <input type="text" class="form-control" id="inputNombreAlmacen" placeholder="Ingresa nombre del almacén" value="<?php echo $datos['datos'][1] ?>" style="width: 100%" data-parsley-required="true"/>                            
        </div>
    </div>
