...
//        echo "<pre>", var_dump($modelos), "</pre>";
            ...
            <div class="row">
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <div class="form-group">
                        <label class="f-w-700">Equipo *</label>
                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <div class="form-group">
                        <label class="f-w-700">Refacción/Componente </label>
                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <div class="form-group">
                        ...
                        <input class="form-control" id="txtCantidad" type="number" style="width: 100%" value="1" min="1"  />
                    </div>
                </div>
            </div>
        </form>
                ...
                <div class="row">
                    ...
                    <div class="col-md-5 col-sm-5 col-xs-12">
                        <div class="form-group">
                            ...
                            <select id="list-info-estatus-1" class="form-control" data-parsley-required="true">
                                <option value="">Selecciona . . .</option>
                                <?php
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12 text-center">                    
                <a id="btnGuardarProductoPoliza" class="btn btn-success m-15">Guardar producto(s)</a>
            </div>
        </div>        
    </div>        
</div>