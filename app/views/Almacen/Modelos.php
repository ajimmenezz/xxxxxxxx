...
<div id="content" class="content">
    ...
    <h1 class="page-header">Catálogo <small>de Modelos de Equipo</small></h1>
    <!-- Finalizando titulo de la pagina -->
    <!-- Empezando panel catálogo de Modelos -->
    <div id="seccionModelos" class="panel panel-inverse">
        ...
        <div class="panel-heading">
            ...
            <h4 class="panel-title">Catálogo de Modelos de Equipo</h4>
        </div>
        ...
        <div class="panel-body">
            <!--Empezando fila 1 -->
            <div class="row" >
                <div id="formularioModelo" class="col-md-12 col-xs-12 hidden" ></div>
            </div>
            <!--Finalizando fila 1-->
            ...
            <div id='listaModelos' class="row"> 
                <div class="col-md-12 col-xs-12">
                    <div class="row">
                        <!--Empezando error--> 
                        <div class="col-md-12">
                            <div class="errorListaModelos"></div>
                        </div>
                        <!--Finalizando Error-->
                    </div>

                    <div class="row">
                        <!--Empezando tabla de modelos--> 
                        <div class="col-md-12">                        
                            <div class="form-group">
                                <div class="col-md-6">
                                    <h3 class="m-t-10">Lista de Modelos</h3>
                                </div>
                                <div class="col-md-6">
                                ...
                                <table id="data-table-modelos" class="table table-hover table-striped table-bordered no-wrap" style="cursor:pointer" width="100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="desktop tablet-l">No. Parte</th>
                                            <th class="all">Marca</th>
                                            <th class="desktop tablet-l">Sublínea</th>
        ...
        <!-- Finalizando panel catálogo de Modelos -->
    </div>
