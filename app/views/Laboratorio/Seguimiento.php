<!-- Empezando #contenido -->
<div id="listaLaboratorio" class="content">
    <!-- Empezando titulo de la pagina -->
    <h1 class="page-header">Seguimiento Laboratorio</h1>
    <!-- Finalizando titulo de la pagina -->
    <!-- Empezando panel seguimiento laboratorio -->
    <div id="panelSeguimientoLaboratorio" class="panel panel-inverse">
        ...
        <div class="panel-heading">
            ...
            <h4 class="panel-title">Seguimiento Laboratorio</h4>
        </div>
        ...
        <div class="panel-body">
            <div class="row"> 
                <!--Empezando error--> 
                <div class="col-md-12">
                    <div class="errorListaLaboratorio"></div>
                </div>
                <!--Finalizando Error-->
                <div class="col-md-12">  
            ...
            <div class="table-responsive">
                <table id="data-table-laboratorio" class="table table-hover table-striped table-bordered no-wrap" style="cursor:pointer" width="100%">
                    <thead>
                        <tr>
    ...
    <!-- Finalizando panel seguimiento laboratorio -->   
</div>
