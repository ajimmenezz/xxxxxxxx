<!--
 * Description: Vista de seguimiento de Metodos y Procedimientos
 *
 * @author: Alberto Barcenas
 *
-->
<!-- Empezando #contenido -->
<div id="listaMetodosProcedimientos" class="content">

    <!-- Empezando titulo de la pagina -->
    <h1 class="page-header">Seguimiento Métodos y Procedimientos</h1>
    <!-- Finalizando titulo de la pagina -->

    <!-- Empezando panel seguimiento Metodos y Procedimientos -->
    <div id="panelSeguimientoMetodosProcedimientos" class="panel panel-inverse">
        ...
        <div class="panel-heading">
            ...
            <h4 class="panel-title">Seguimiento Métodos y Procedimientos</h4>
        </div>
        ...
        <div class="panel-body">
            <div class="row"> 
                ...
                <!--Empezando error--> 
                <div class="col-md-12">
                    <div class="errorListaMetodosProcedimientos"></div>
                </div>
                <!--Finalizando Error-->
            ...
            <div class="table-responsive">
                <table id="data-table-metodos-procedimientos" class="table table-hover table-striped table-bordered no-wrap" style="cursor:pointer" width="100%">
                    <thead>
                        <tr>
    ...
    <!-- Finalizando panel seguimiento MetodosProcedimientos -->
