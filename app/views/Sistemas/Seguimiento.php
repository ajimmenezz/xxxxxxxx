...
<div id="listaServicio" class="content">
    ...
    <h1 class="page-header">Seguimiento Sistemas</h1>
    <!-- Finalizando titulo de la pagina -->
    <!-- Empezando panel seguimiento Mesa de Ayuda-->
    <div id="panelSeguimientoSistemas" class="panel panel-inverse">
        <!--Empezando cabecera del panel-->
        <div class="panel-heading">
            <div class="panel-heading-btn">                
                <a href="javascript:;" class="btn btn-xs btn-icon btn-circle btn-warning" data-click="panel-collapse"><i class="fa fa-minus"></i></a>                            
            </div>
            <h4 class="panel-title">Seguimiento Sistemas</h4>
        </div>
        ...
        <div class="panel-body">
            ...
            <div class="table-responsive">
                <table id="data-table-sistemas" class="table table-hover table-striped table-bordered no-wrap" style="cursor:pointer" width="100%">
                    <thead>
                        <tr>
