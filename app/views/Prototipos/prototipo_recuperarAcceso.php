...
<!--        <link href="assets/css/customize/recoverPassword.css" rel="stylesheet"/>-->
        ...
        <script src="assets/js/customize/prototipo_recuperarAcceso.js"></script>
            ...
            <div class="login login-with-news-feed">
                ...
                <div class="right-content">
                    ...
                    <div class="login-content">
                        ...
                        <form class="margin-bottom-0" id="recuperar">
                            ...
                            <div class="row m-b-15">
                                <div class="col-md-12">
                                    <input type="text" class="form-control" placeholder="Direccion de Email" id="correo"/>
                                </div>
                            </div>
                            ...
                            <div class="login-buttons">
                                <button type="button" class="btn btn-success" id="btnRecuperar" >Enviar</button>
