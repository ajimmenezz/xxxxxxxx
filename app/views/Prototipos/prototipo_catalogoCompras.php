...
<html lang="en">
    ...
    <head>
        ...
        <link href="assets/css/customize/prototipo_catalogoCompras.css" rel="stylesheet"/>
        ...
        <script src="assets/js/customize/prototipo_catalogoCompras.js"></script>
    ...
    <body class="pace-top">
        ...
        <div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
            ...
            <div id="content" class="content">
                ...
                <h1 class="page-header">Catálogos <small>de compras</small></h1>
                <!-- Finalizando titulo de la pagina -->

                <!-- Empezando panel catálogo de compras -->
                <div class="panel panel-inverse">
                    ...
                    <div class="panel-body">
                        <!--Inicia formulario para catálogo de material-->
                        <form action="/" method="POST">
                            <fieldset>                                                                                                                                                                                        
                                ...
                                <div class="row m-t-10">                                  
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="inputNombreMaterial">Material</label>
                                            <input type="text" class="form-control" id="inputNombreMaterial" placeholder="Ingresa el nombre del material"/>                                            
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="inputNumeroParteMaterial">Numero de Parte</label>
                                            <input type="text" class="form-control" id="inputNumeroParteMaterial" placeholder="Ingresa el numero de parte"/>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="inputProvedorMaterial">Provedor</label>
                                            <input type="text" class="form-control" id="inputProvedorMaterial" placeholder="Ingresa el provedor"/>
                                        </div>
                                    </div>                                  
                                </div>
                                <!--Finalizando campos fila 1-->
                                <!--Empezando campos fila 2 -->
                                <div class="row ">                                                                      
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="inputPrecioMaterial">Precio</label>
                                            <input type="text" class="form-control" id="inputPrecioMaterial" placeholder="Ingresa el nombre del material"/>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="selectTipoMoneda">Moneda</label>
                                            <select id="selectTipoMoneda" class="form-control" style="width: 100%" required>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="textareaDescripcionMaterial">Descripción</label>
                                            <textarea class="form-control" id="textareaDescripcionMaterial" placeholder="Descripción del material" rows="1"></textarea>
                                        </div>
                                    </div>
                                </div>
                                <!--Finalizando campos fila 2-->
                                <!--Empezando campos fila 3 -->
                                <div class="row ">                                                                      
                                ...
                                <!--Finalizando campos fila 3-->
                                <!--Empezando Tabla material fila 4 -->
                                <div class="row ">                                                                                                          
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <table id="data-table-materiales" class="table table-hover table-striped table-bordered no-wrap" style="cursor:pointer" width="100%">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="all">Provedor</th>
                                                        <th class="all">Descripción</th>
                                                        <th class="desktop">Precio</th>
                                                        <th class="desktop">Moneda</th>
                                                        <th class="all">Estatus</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <tr>
                                                        <td>BOBINA DE CABLE UTP</td>
                                                        <td>PUP6004BU-U</td>
                                                        <td>STEREN</td>
                                                        <td>CLAVE DE RED SE UTILIZA PARA ....</td>
                                                        <td>$20.00</td>
                                                        <td>DOLARES</td>
                                                        <td>ACTIVO</td>
                                                    </tr>
                                                    <tr>
                                                        <td>PATCH CORD 5FT AZUL</td>
                                                        <td>UTPS5BUY</td>
                                                        <td>STEREN</td>
                                                        <td>CLAVE DE RED SE UTILIZA PARA ....</td>
                                                        <td>$15.00</td>
                                ...
                                <!--Finalizando Tabla material fila 4-->
                            </fieldset>
                        </form>
                        <!-- Finaliza formulario para catálogo de material-->
                    </div>
                    <!--Finalizando cuerpo del panel-->
                </div>
                <!-- Finalizando panel catálogo de compras -->
