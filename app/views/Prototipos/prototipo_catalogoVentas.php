...
<html lang="en">
    ...
    <head>
        ...
        <link href="assets/css/customize/prototipo_catalogoVentas.css" rel="stylesheet"/>
        ...
        <script src="assets/js/customize/prototipo_catalogoVentas.js"></script>
    ...
    <body class="pace-top">
        ...
        <div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
            ...
            <div id="content" class="content">
                ...
                <h1 class="page-header">Catálogos <small>de ventas</small></h1>
                ...
                <div class="panel panel-inverse">
                    ...
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title">Precio de venta</h4>
                    </div>
                                ...
                                <div class="row ">                                                                                                          
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <table id="data-table-venta" class="table table-hover table-striped table-bordered no-wrap" style="cursor:pointer" width="100%">
                                                <thead>
                                                    <tr>
