...
<html lang="en">
    ...
    <head>
        ...
        <link href="assets/css/customize/prototipo_solicitud.css" rel="stylesheet"/>
        ...
        <script src="assets/plugins/jquery-fileUpload/js/plugins/canvas-to-blob.min.js"></script>
        <script src="assets/plugins/jquery-fileUpload/js/fileinput.min.js"></script>
        <script src = "assets/plugins/jquery-fileUpload/js/fileinput_locale_es.js"></script>
        <script src="assets/plugins/parsley/dist/parsley.js"></script>
        <script src="assets/plugins/parsley/src/i18n/es.js"></script>
        <script src="assets/js/apps.min.js"></script>
        <script src="assets/js/customize/prototipo_solicitud.js"></script>
    ...
    <body class="pace-top">
        ...
        <div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
            ...
            <div id="content" class="content">
                ...
                <!-- Empezando panel Nueva Solicitud-->
                    ...
                    <div class="panel-body">
                        ...
                        <form action="/" method="POST">
                            <fieldset>                               
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="textareaDescripcionNuevaSolicitud" placeholder="Describe lo que se requiere aqui ...." rows="5" ></textarea>
                                        </div>
                                    </div> 
                                </div>
                                <!--Finalizando fila 1-->
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <label class="control-label">Agregar Evidencia</label>            
                                        <input name="files" type="file" multiple class="file-loading" id="fileUploadSolicitudNueva">                                        
                                    </div>
                                </div>    
                                <!--Finalizando fila 2-->                                
                                ...
                                <div class="row m-t-20">
                                    ...
                                    <div class="col-md-12 text-right">                                        
                                        <button type="button" class="btn btn-sm btn-default m-r-5" id="btnGenerarSolicitud">Generar</button>
                                    </div>
                                </div>
                ...
                <!-- Finalizando panel Nueva Solicitud -->
                ...
                <div class="panel panel-inverse">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">                           
                            <div class="col-md-12">
                                <table id="data-table-generadas" class="table table-hover table-striped table-bordered no-wrap" style="cursor:pointer" width="100%">
                                    <thead>
                                        <tr>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>15/12/2016</td>
                                            <td>Sin Atender</td>
                                            <td>Sed in ante vel ipsum tristique euismod posuere eget nulla. Quisque ante sem, scelerisque iaculis interdum quis, eleifend id mi. Fusce congue leo nec mauris malesuada, id scelerisque sapien ultricies.</td>
                                        </tr>
                                        <tr>
                                            <td>98267</td>
                                            <td>10/12/2016</td>
                ...
                <!-- Empezando panel Solicitudes Asignadas-->
                <div class="panel panel-inverse">
                    <div class="panel-heading">
                        <div class="panel-heading-btn">
                            <a href="javascript:;" class="btn btn-xs btn-icon btn-circle btn-default" data-click="panel-expand"><i class="fa fa-expand"></i></a>                            
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">                           
                            <div class="col-md-12">
                                <table id="data-table-asignadas" class="table table-hover table-striped table-bordered no-wrap" style="cursor:pointer" width="100%">
                                    <thead>
                                        <tr>
                                            <th class="all">Solicitud</th>
                ...
                <!-- Finalizando panel Solicitudes Asignadas -->
