...
<html lang="en">
    ...
    <head>
        ...
        <!--<link href="assets/css/customize/login.css" rel="stylesheet"/>-->
        ...
        <script src="assets/js/customize/prototipo_login.js"></script>
            ...
            <div class="login login-with-news-feed">
                ...
                <div class="right-content">
                    ...
                    <div class="login-content">
                        ...
                        <form class="margin-bottom-0" id="ingreso">
                            <div class="form-group m-b-15">
                                <input type="text" class="form-control input-lg" placeholder="Usuario" id="txtUser"/>
                            </div>
                            <div class="form-group m-b-15">
                                <input type="password" class="form-control input-lg" placeholder="Password" id="txtPass"/>
                            </div>
                            <div class="checkbox m-b-30" id="divPassForgot">
                                <!--muestra el mensaje de error con el usuario y contraseña-->
                                <label class="alert text-danger hidden" role="alert"></label>
                            </div>
                            <div class="login-buttons">
                                <button type="button" class="btn btn-success btn-block btn-lg" id="btnIngresar" >Entrar</button>
                            </div>
                            <div class="m-t-20 m-b-40 p-b-40">
                                No recuerdo mi contraseña? Click <a href="javascript:;" id="resetearPws"class="text-success">aqui</a> para recuperar.
                            </div>
                            <hr />
