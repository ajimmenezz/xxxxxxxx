<!-- Empezando #contenido -->
<div id="listaAdministrador" class="content">
    <!-- Empezando titulo de la pagina -->
    <h1 class="page-header">Seguimiento Administrador</h1>
    <!-- Finalizando titulo de la pagina -->
    <!-- Empezando panel seguimiento administracion -->
    <div id="panelSeguimientoAdministracion" class="panel panel-inverse">
        ...
        <div class="panel-heading">
            ...
            <h4 class="panel-title">Seguimiento Administrador</h4>
        </div>
        ...
        <div class="panel-body">
            <div class="row"> 
                <!--Empezando error--> 
                <div class="col-md-12">
                    <div class="errorListaAdministrador"></div>
                </div>
                <!--Finalizando Error-->
                <div class="col-md-12">  
            ...
            <div class="table-responsive">
                <table id="data-table-administrador" class="table table-hover table-striped table-bordered no-wrap" style="cursor:pointer" width="100%">
                    <thead>
                        <tr>
    ...
    <!-- Finalizando panel seguimiento administrador -->   
</div>
