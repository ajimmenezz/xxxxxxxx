<div id="divMisSolicitudesCompra" class="content">
    <h1 class="page-header">Solicitudes de compra por autorizar</h1>
    <div id="panelAutorizarSolicitudesCompra" class="panel panel-inverse">
        <div class="panel-heading"></div>
        <div class="panel-body">
            <div class="row">
                <div class="col-md-12">
                    <h3 class="m-t-10">Lista de pendientes</h3>
                </div>
                <div class="col-md-12">
