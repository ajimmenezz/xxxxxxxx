...
<div id="listaContabilidad" class="content">
    ...
    <h1 class="page-header">Seguimiento Contabilidad</h1>
    <!-- Finalizando titulo de la pagina -->
    <!-- Empezando panel seguimiento contabilidad-->
    <div id="panelSeguimientoContabilidad" class="panel panel-inverse">
        ...
        <div class="panel-heading">
            ...
            <h4 class="panel-title">Seguimiento Contabilidad</h4>
        </div>
        ...
        <div class="panel-body">
            <div class="row"> 
                <!--Empezando error--> 
                <div class="col-md-12">
                    <div class="errorListaContabilidad"></div>
                </div>
                <!--Finalizando Error-->
                <div class="col-md-12">  
            ...
            <div class="table-responsive">
                <table id="data-table-contabilidad" class="table table-hover table-striped table-bordered no-wrap" style="cursor:pointer" width="100%">
                    <thead>
                        <tr>
    ...
    <!-- Finalizando panel seguimiento contabilidad -->   
</div>
