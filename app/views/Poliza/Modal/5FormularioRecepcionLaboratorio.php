...
<div id="panelRecepcionLaboratorio" class="panel panel-inverse">
    <div class="panel-heading">
        <h4 class="panel-title">3) Recepción en Laboratorio</h4>
    </div>
                ...
                <form id="formRecepcionAlmacen" data-parsley-validate="true">
                    <fieldset>
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12 text-center <?php echo $mostrarSelect ?>">
                            <a id="btnGuardarRecepcionLab" class="btn btn-primary m-t-10 m-r-10 f-w-600 f-s-13"><i class="fa fa-save"></i> Guardar Recepción</a>
                        </div>
                    </fieldset>
                </form>
            </div>
            <div class="tab-pane fade" id="problemasRecepcionLab">
                <form id="formProblemaRecepcionAlmacen" data-parsley-validate="true">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div id="errorAgregarProblemaLab"></div>
                        </div>
                    </div>
                    <div>
                ...
                <div class="timelineTareas" id="divNotasAdjuntosLaboratorio"></div>
            </div>                
        </div>
    </div>
</div>