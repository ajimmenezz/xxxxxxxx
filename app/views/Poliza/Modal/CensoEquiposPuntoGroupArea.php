    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        ...
        ?>
                    <div class="col-md-2 col-sm-4 col-xs-6 m-t-5 m-b-10">
                        <a data-area="<?php echo $value['IdArea']; ?>" data-punto="<?php echo $i; ?>" data-unidad-negocio=<?php echo $unidadNegocio; ?> class="btn <?php echo $classButton; ?> btn-block f-w-600 f-s-13 btnPuntoArea">
