    ...
    <div class="col-md-6 col-xs-6 text-right">
        <div class="btn-group">
            ...
            <ul class="dropdown-menu">
                <li id="btnAgregarAvance"><a href="#">Agregar Avance</a></li>
                <li id="btnAgregarProblema"><a href="#">Agregar Problema</a></li>
                <li id="btnEnviarReporteProblema"><a href="#">Firmar Servicio</a></li>
                <li id="btnGeneraPdfServicio"><a href="#">Generar Pdf</a></li>
                <li id="btnSubirInformacionSD"><a href="#">Subir a SD</a></li>
                <li class="divider"></li>
                <?php //echo $informacion['botonAgregarVuelta'] 
                ?>
                <li id="btnNuevoServicioSeguimiento"><a href="#">Nuevo Servicio</a></li>
                <li id="btnCancelarServicioSeguimiento"><a href="#">Cancelar Servicio</a></li>
                <li id="btnReasignarServicio"><a href="#">Reasignar Servicio</a></li>
                <li id="btnNuevaSolicitud"><a href="#">Solicitar Apoyo</a></li>
                <?php
                if ($datosServicio["IdEstatus"] == 3)
                    //echo '<li class="solicitarTraslado"><a href="#">Generar Traslado</a></li>';
                ?>
            </ul>
        </div>
    ...
    <div class="panel-heading p-0">
        ...
        <div class="tab-overflow">
            <ul class="nav nav-tabs nav-tabs-inverse">
                ...
                <li class=""><a href="#DeviceTransfers" data-toggle="tab">Trasladar o Solicitar Equipo</a></li>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">                                    
                                                        <div class="form-group">
                                                            ...
                                                            ?>
                                                            <textarea id="inputComentariosEnvioGarantia" class="form-control " placeholder="Ingrese los comentarios" rows="3" ><?php // echo $valor; 
                                                                                                                                                                                ?></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div id="entregaFechaGarantia" class="input-group date">
                                                                <input id="entregaFechaEnvioGarantia" type="text" class="form-control entregaGarantia" placeholder="Fecha" value="<?php // echo $valor; 
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">                                    
                                                        <div class="form-group">
                                                            ...
                                                            ?>
                                                            <textarea id="inputComentarioEntregaEnvioGarantia" class="form-control entregaGarantia" placeholder="Ingrese los comentarios" rows="3" disabled><?php // echo $valor; 
                                                                                                                                                                                                            ?></textarea>
                                                        </div>
                                                    </div>
                                                </div>
...
-->
        ...
        <!--Empezando la seccion de Trasladar o Solicitar Equipo-->
        <div class="tab-pane fade " id="DeviceTransfers"></div>
        <!--Finalizando la seccion Trasladar o Solicitar Equipo-->
