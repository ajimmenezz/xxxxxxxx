...
<div id="panelRecepcionLogistica" class="panel panel-inverse">
    <div class="panel-heading">
        <h4 class="panel-title">8) Recepción en Tecnico</h4>
    </div>
    <div class="panel-body">
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <legend>Documentación de recepción en Tecnico</legend>
            </div>
        </div>
        <div class="row"></div>
        <ul class="nav nav-pills">
            <li class="active"><a href="#RecepcionTenico" data-toggle="tab">Recepcion</a></li>
                ...
                <form id="formRecepcionAlmacen" data-parsley-validate="true">
                    <fieldset>
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12 text-center <?php echo $mostrarSelect ?>">
                            <a id="btnGuardarRecepcionTec" class="btn btn-success m-t-10 m-r-10 f-w-600 f-s-13">Guardar Recepción</a>
                        </div>
                    </fieldset>
                </form>
            </div>
                    ...
                    <div class="row">
                        <div class="col-md-9 col-sm-12 col-xs-12">
                            <div class="form-group">
                                ...
                                <input id="adjuntosProblemaTec" name="adjuntosTarea[]" type="file" multiple="" <?php echo $mostrarSelectInputProblema ?>/>    
                            </div>
                        </div>
                    </div>
                    <div>
                        <div class="col-md-12 col-sm-12 col-xs-12 text-center <?php echo $mostrarBtnProblema ?>">
                            <a id="btnAgregarProblemaTec" class="btn btn-success m-t-10 m-r-10 f-w-600 f-s-13">Agregar Problema</a>
                        </div>
                    </div>
                </form>
            </div>                
