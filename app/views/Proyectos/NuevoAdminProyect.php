    ...
    <div id="panel-table-proyectos" class="panel panel-inverse">
        ...
        <div class="panel-heading">
            <div class="panel-heading-btn">
                <!--<button id="btn-proyecto-nuevo" type="button" class="btn btn-success btn-xs"><i class="fa fa-file"></i> Nuevo proyecto</button>-->
                ...
                <div id="cuerpo-alcance">
                    ...
                    <div class="row">
                        <div class="col-md-12 text-center m-t-20">
                            ...
                            <button id="btn-nuevo-nodo" type="button" class="btn btn-sm btn-success"><i class="fa fa-plus"></i> Agregar Ubicación</button>
                            <button id="btn-lista-nodos" type="button" class="btn btn-sm btn-default"><i class="fa fa-list"></i> Lista de Ubicaciones</button>
                        </div>
                    </div>
                    <!--Finalizando botones alcance-->

                    <!--Empezando Mensaje Solicitud-->
                    <div id="alerta-solicitud-material-generada" class="row hidden">
                        <div class="col-md-12">                                
                            <div class="alert alert-info fade in ">
                                <strong>Informacion : </strong>
                                Ya se genero la solicitud <span id="num-solicitud-material"></span> al área de almancén. Por tal motivo ya no es posbible agregar mas nodos al proyecto.
                            </div>
                        </div>
                    </div>
                    <!--Finalizando Mensaje Solicitud--> 
                </div>
                <!--Finalizando Cuerpo-->
            </div>
            <!--Finalizando formulario Alcance-->                
