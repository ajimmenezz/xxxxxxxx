<div id="seccionCatalogos" class="content">
    ...
    <h1 class="page-header">Catálogos <small> Proyectos Especiales</small></h1>
    ...
    <div id="panel-catalogos" class="panel panel-inverse panel-with-tabs" data-sortable-id="ui-unlimited-tabs-1">
        ...
        <div class="panel-heading p-0">
            ...
            <div class="tab-overflow">
                <ul class="nav nav-tabs nav-tabs-inverse">
                    ...
                    <li class="active"><a href="#Sistemas" data-toggle="tab">Sistemas</a></li>
                    <li class=""><a href="#Tipos" data-toggle="tab">Tipos de Proyecto</a></li>
        ...
        <div class="tab-content">
            ...
            <!--Empezando la seccion Sistemas-->
            <div class="tab-pane fade active in" id="Sistemas">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-md-offset-6 col-sm-offset-6 col-sm-6 col-xs-offset-0 col-xs-12">
                            <div class="input-group">
                                ...
                                <span role="button" id="btnAddSistema" class="input-group-addon bg-aqua"><i class="fa fa-plus text-white"></i></span>
                            </div>
                        </div>
                    </div>
                    <div class="row">
            ...
            <!--Empezando la seccion Tipos de Proyecto-->
