<div class="row">
    <div class="col-md-9 col-sm-6 col-xs-12">
        <h1 class="page-header">Agregar Kit de Material</h1>
    </div>
...
<div id="panelKitMaterial" class="panel panel-inverse">        
    <div class="panel-heading">  
        <h4 class="panel-title">Agregat Kit de Material</h4>        
    </div>
    <div class="panel-body">
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <h4>Agregar Kit de Materiales</h4>
        ...
        <div class="row">
            <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="form-group">
                    <?php
                    $id = isset($idKit) ? $idKit : 0;
                    ?>
                    <input type="hidden" id="idKit" value="<?php echo $id; ?>" />
                    <label class="f-s-13 f-w-600">Nombre del Kit*</label>
                    <input type="text" id="txtKit" class="form-control" placeholder="Ej. Nodo Taquilla" />                    
                </div>
            </div>
        </div>
        <div class="row">
