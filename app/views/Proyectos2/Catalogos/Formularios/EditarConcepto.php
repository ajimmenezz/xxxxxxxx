<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">        
        <input type="hidden" id="idConcepto" value="<?php echo $data['Id']; ?>" />
        <div class="form-group">
            <label class="f-w-600">Concepto:</label>
            <input class="form-control" type="text" id="txtConcepto" value="<?php echo $data['Nombre']; ?>" placeholder="Concepto de Sistema" />
        </div>
    </div>
</div>
<div class="row">
