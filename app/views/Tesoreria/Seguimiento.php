<!-- Empezando #contenido -->
<div id="listaTesoreria" class="content">

    <!-- Empezando titulo de la pagina -->
    <h1 class="page-header">Seguimiento Tesorería</h1>
    <!-- Finalizando titulo de la pagina -->

    <!-- Empezando panel seguimiento Tesoreria-->
    <div id="panelSeguimientoTesoreria" class="panel panel-inverse">
        ...
        <div class="panel-heading">
            ...
            <h4 class="panel-title">Seguimiento Tesorería</h4>
        </div>
        ...
        <div class="panel-body">
            <div class="row"> 
                ...
                <!--Empezando error--> 
                <div class="col-md-12">
                    <div class="errorListaTesoreria"></div>
                </div>
                <!--Finalizando Error-->
            ...
            <div class="table-responsive">
                <table id="data-table-tesoreria" class="table table-hover table-striped table-bordered no-wrap" style="cursor:pointer" width="100%">
                    <thead>
                        <tr>
    ...
    <!-- Finalizando panel seguimiento tesoreria -->
