...
<div id="listaServicio" class="content">
    ...
    <h1 class="page-header">Seguimiento Mesa de Ayuda</h1>
    <!-- Finalizando titulo de la pagina -->
    <!-- Empezando panel seguimiento Mesa de Ayuda-->
    <div id="panelSeguimientoMesaDeAyuda" class="panel panel-inverse">
        ...
        <div class="panel-heading">
            ...
            <h4 class="panel-title">Seguimiento Mesa de Ayuda</h4>
        </div>
        ...
        <div class="panel-body">
            <div class="row"> 
                <!--Empezando error--> 
                <div class="col-md-12">
                    <div class="errorListaMesaDeAyuda"></div>
                </div>
                <!--Finalizando Error-->
                <div class="col-md-12">  
            ...
            <div class="table-responsive">
                <table id="data-table-mesaDeAyuda" class="table table-hover table-striped table-bordered no-wrap" style="cursor:pointer" width="100%">
                    <thead>
                        <tr>
                            <th class="never">Id</th>
                            <th class="all">Ticket</th>
                            <th class="all">IdSolicitud</th>
