<!-- Empezando #contenido -->
<div id="listaRedes" class="content">
    <!-- Empezando titulo de la pagina -->
    <h1 class="page-header">Seguimiento Redes</h1>
    <!-- Finalizando titulo de la pagina -->
    <!-- Empezando panel seguimiento redes-->
    <div id="panelSeguimientoRedes" class="panel panel-inverse">
        ...
        <div class="panel-heading">
            ...
            <h4 class="panel-title">Seguimiento Redes</h4>
        </div>
        ...
        <div class="panel-body">
            ...
            <div class="table-responsive">
                <table id="data-table-redes" class="table table-hover table-striped table-bordered no-wrap" style="cursor:pointer" width="100%">
                    <thead>
                        <tr>
                            <th class="never">Id</th>
                            <th class="all">Ticket</th>
                            <th class="sll">Servicio</th>
    ...
    <!-- Finalizando panel seguimiento redes -->   
</div>
